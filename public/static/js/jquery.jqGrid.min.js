...
(function ($) {
			...
			if (void 0 === d && (d = $.jgrid.getRegional(this, "formatter.date")), void 0 === d.parseRe && (d.parseRe = /[#%\\\/:_;.,\t\s-]/), d.masks.hasOwnProperty(a) && (a = d.masks[a]), b && null != b)
				if (isNaN(b - 0) || "u" !== String(a).toLowerCase())
					if (b.constructor === Date)
						...
						o = new Date(parseInt(l[1], 10)), l[3] && (q = 60 * Number(l[5]) + Number(l[6]), q *= "-" === l[4] ? 1 : -1, q -= o.getTimezoneOffset(), o.setTime(Number(Number(o) + 60 * q * 1e3)));
					else {
				...
				o = new Date(n.y, n.m, n.d, n.h, n.i, n.s, n.u);
			if (d.userLocalTime && 0 === q && (q -= (new Date).getTimezoneOffset(), q > 0 && o.setTime(Number(Number(o) + 60 * q * 1e3))), void 0 === c)
				return o;
			...
			if (!this.grid) {
				...
				F = function (a) {
					...
					for (c = 0; c < d.p.colModel.length; c++)
						b = d.p.colModel[c], "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name,
				...
				I = function () {
					...
					if ("local" === m.datatype && p.repeatitems === !0)
						for (j = G(s), k = F("local"), e = m.keyIndex === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex, a = 0; o > a; a++) {
							for (c = n[a], f = $.jgrid.getAccessor(c, e), void 0 === f && ("number" == typeof e && null != q[e + s] && (f = $.jgrid.getAccessor(c, q[e + s].name)), void 0 === f && (f = t + a, r && (g = $.jgrid.getAccessor(c, r) || c, f = null != g && void 0 !== g[e] ? g[e] : f, g = null))), i = {}, i[p.id] = f, r && (c = $.jgrid.getAccessor(c, r) || c), l = $.isArray(c) ? j : k, b = 0; b < l.length; b++)
				...
				L = function (a, b, c, e) {
					...
					if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
						...
						$.isFunction(i.userdata) ? d.p.userData = i.userdata.call(d, a) || {}
							...
							for (d.p.grouping && (Y = d.p.groupingView.groupCollapse === !0, W = $.jgrid.getMethod("groupingPrepare")); Q > R; ) {
								...
								if (L.push(""), B && L.push(E(0, R, d.p.page, d.p.rowNum, Z)), z && L.push(D(u, B, R, !1, _)), A && L.push(p.call(w, z + B, R + b)), i.repeatitems) {
									...
									for (m = 0; m < I.length; m++)
										o = $.jgrid.getXmlData(t, I[m]), J[d.p.colModel[m + z + A + B].name] = o, L.push(C(u, o, m + z + A + B, R + b, t, J));
								if (L[aa] = K(u, Y, v, J, t), L.push("</tr>"), d.p.grouping && (S.push(L), d.p.groupingView._locgr || W.call(w, J, R), L = []), (g || d.p.treeGrid === !0 && !d.p._ald) && (J[h] = $.jgrid.stripPref(d.p.idPrefix, u), d.p.data.push(J), d.p._index[J[h]] = d.p.data.length - 1), d.p.gridview === !1 && (V.append(L.join("")), w.triggerHandler("jqGridAfterInsertRow", [u, J, t]), X && d.p.afterInsertRow.call(d, u, J, t), L = []), J = {}, x++, R++, x === T)
									break
							}
						}
						if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), S = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(L.join("")) : (V.append(L.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0)
							try {
						...
						if (d.p.reccount = x, d.p.treeANode = -1, d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, !0), g && (d.p.records = Q, d.p.lastpage = Math.ceil(Q / T)), c || d.updatepager(!1, !0), g) {
							for (; Q > x; ) {
								if (t = O[x], u = r(t, x + U), u = d.p.idPrefix + u, i.repeatitems) {
									...
									for (m = 0; m < I.length; m++)
										o = $.jgrid.getXmlData(t, I[m]), J[d.p.colModel[m + z + A + B].name] = o;
				...
				M = function (a, b, c, e) {
					...
					if (a) {
						...
						j && (d.p.data = [], d.p._index = {}, d.p.localReader.id = i),
						d.p.reccount = 0,
						...
						for (d.p.grouping && (aa = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o; ) {
							...
							var fa = Q.length;
							for (Q.push(""), M && Q.push(E(0, o, d.p.page, d.p.rowNum, ca)), J && Q.push(D(x, M, o, U, da)), L && Q.push(r.call(A, J + M, o + b)), s = O, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)), p = 0; p < s.length; p++)
						...
						if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (ba.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0)
							try {
				...
				N = function () {
						...
						if (null != b.rules)
							try {
								for (f = b.rules.length && "OR" === b.groupOp.toString().toUpperCase(), f && r.orBegin(), c = 0; c < b.rules.length; c++)
									h = b.rules[c], g = b.groupOp.toString().toUpperCase(), q[h.op] && h.field && (k > 0 && g && "OR" === g && (r = r.or()), i = j[h.field], "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(d, i.newfmt, h.data, i.srcfmt)), r = q[h.op](r, g)(h.field, h.data, j[h.field])), k++;
								f && r.orEnd()
							} catch (m) {
								alert(m)
							}
					...
					if ($.isArray(d.p.data)) {
						...
						if ($.each(d.p.colModel, function () {
								if (c = this.sorttype || "text", o = this.index || this.name, "date" === c || "datetime" === c ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (b = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(d, "formatter.date.srcformat"), e = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(d, "formatter.date.newformat")) : b = e = this.datefmt || "Y-m-d", j[o] = {
									...
									for (n = 0, m = p.groupField.length; m > n; n++)
										this.name === p.groupField[n] && (k[n] = j[o], l[n] = o);
						...
						if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
							...
							if (u)
								"string" == typeof u && (u = $.jgrid.parse(u)), a(u);
							else
								try {
						...
						if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (m = 0, g = null), d.p.grouping)
							for (n = 0; m > n; n++)
								r.orderBy(l[n], p.groupOrder[n], k[n].stype, k[n].srcfmt);
						...
						if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
							...
							if (d.p.footerrow && d.p.userDataOnFooter) {
								for (D in d.p.userData)
									d.p.userData.hasOwnProperty(D) && (d.p.userData[D] = 0);
								E = !0
							}
							for (C = 0; y > C; C++) {
								if (E)
									for (D in d.p.userData)
										d.p.userData.hasOwnProperty(D) && (d.p.userData[D] += parseFloat(w[C][D] || 0));
								F.call($(d), w[C], C, x)
							}
						}
				...
				R = function (a) {
					if (!d.grid.hDiv.loading) {
						...
						if ($.isFunction(d.p.beforeRequest) && (p = d.p.beforeRequest.call(d), void 0 === p && (p = !0), p === !1))
							return;
				...
				T = function (a, b) {
					...
					if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
						...
						for (n = 0; n < d.p.rowList.length; n++)
							v = d.p.rowList[n].toString().split(":"), 1 === v.length && (v[1] = v[0]), t += '<option role="option" value="' + v[0] + '"' + (y(d.p.rowNum, 0) === y(v[0], 0) ? ' selected="selected"' : "") + ">" + v[1] + "</option>";
						t += "</select></td>"
					}
				...
				U = function (a, b) {
					...
					var h = s.indexOf(c);
					-1 === h ? (s.push(c), t.push(g)) : g ? t[h] = g : (t.splice(h, 1), s.splice(h, 1)),
					d.p.sortorder = "",
					d.p.sortname = "";
					for (var i = 0, j = s.length; j > i; i++)
						i > 0 && (d.p.sortname += ", "), d.p.sortname += s[i], i !== j - 1 && (d.p.sortname += " " + t[i]);
					d.p.sortorder = t[j - 1]
				},
				...
				W = function () {
					...
					d.p.shrinkToFit === !0 && i > 0 && (c = e.width - h * i - l, isNaN(d.p.height) || (c -= j, k = !0), g = 0, $.each(d.p.colModel, function (e) {
				...
				for (this.p.id = this.id, -1 === $.inArray(d.p.multikey, x) && (d.p.multikey = !1), d.p.keyName = !1, i = 0; i < d.p.colModel.length; i++)
					w = "string" == typeof d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {}
				...
				if ("horizontal" === d.p.viewsortcols[1] ? (la = " ui-i-asc", ma = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (la = " ui-single-sort-asc", ma = " ui-single-sort-desc", ka = " style='display:none'", d.p.viewsortcols[0] = !1), ba = r ? "class='ui-th-div-ie'" : "", ia = "<span class='s-ico' style='display:none'>", ia += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + la + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + ka + "></span>", ia += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ma + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + ka + "></span></span>", d.p.multiSort && d.p.sortname)
					for (s = d.p.sortname.split(","),
						i = 0; i < s.length; i++)
						u = $.trim(s[i]).split(" "), s[i] = $.trim(u[0]), t[i] = u[1] ? $.trim(u[1]) : d.p.sortorder || "asc";
				...
				if (d.p.disableClick = !1, $("th", sa).each(function (a) {
						...
						d.p.colModel[a].resizable ? (ea = document.createElement("span"), $(ea).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : ea = "",
						$(this).css("width", da + "px").prepend(ea),
						ea = null;
						var b = "";
						...
						ka && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), d.p.colModel[a].lso && $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass(m).css("display", "")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass(m).css("display", "")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", "")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", ""))),
				...
				d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
						width: e.width + "px"
					}).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(v), wa && $(d.p.pager).hide(), T(d.p.pager, "")),
				d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function (a) {
					ga = $(a.target).closest("tr.jqgrow"),
					"ui-subgrid" !== $(ga).attr("class") && $(ga).addClass(o)
				...
				$(d).before(e.hDiv).click(function (a) {
					if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 === $(ga).length || ga[0].className.indexOf(m) > -1 || ($(fa, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)
						return this;
					...
					if ("A" !== fa.tagName && ("INPUT" !== fa.tagName && "TEXTAREA" !== fa.tagName && "OPTION" !== fa.tagName && "SELECT" !== fa.tagName || b))
						if (ya = ga[0].id, fa = $(fa).closest("tr.jqgrow>td"), fa.length > 0 && (za = $.jgrid.getCellIndex(fa), Aa = $(fa).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [ya, za, Aa, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ya, za, Aa, a)), d.p.cellEdit !== !0) {
							if (c)
								if (d.p.multikey)
									a[d.p.multikey] ? $(d).jqGrid("setSelection", ya, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya)[d.p.useProp ? "prop" : "attr"]("checked", !b));
									...
									if (b)
										...
										$(d.p.selarrrow).each(function (a, b) {
											...
											f && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass(n), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f))[d.p.useProp ? "prop" : "attr"]("checked", !1))
										}),
										d.p.selarrrow = [],
										$(d).jqGrid("setSelection", ya, !0, a)
									}
					...
					if (d.p.treeGrid === !0 && (d.p.datatype = d.p.treedatatype), b = b || {}, b.current && d.grid.selectionPreserver(d), "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"), d.p.data.length && (I(), J())) : d.p.treeGrid || (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], S(!1)), d.p.savedRow = []), d.p.scroll && H.call(d, !0, !1), b.page) {
						...
						1 > c && (c = 1),
						d.p.page = c,
						d.grid.prevRowHeight ? d.grid.bDiv.scrollTop = (c - 1) * d.grid.prevRowHeight * d.p.rowNum : d.grid.bDiv.scrollTop = 0
					}
					...
					if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 !== $(ga).length) {
						d.p.multiselect || $(d).jqGrid("setSelection", ga[0].id, !0, a),
						ya = ga[0].rowIndex,
						za = $.jgrid.getCellIndex(fa);
				...
				if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), T(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], xa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(xa).width(e.width).insertAfter(e.hDiv), $(xa).append(ra), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), wa && $(e.sDiv).hide()), xa = null, d.p.caption) {
					...
					d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function (a) {
							...
							"visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function () {
								b--,
								0 === b && ($("span", g).removeClass(Ba).addClass(Ca), d.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (wa || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
							}) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function () {
								b--,
								0 === b && ($("span", g).removeClass(Ca).addClass(Ba), wa && (d.p.datatype = Fa, R(), wa = !1), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (wa || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
							}),
							!1
		...
		addRowData: function (a, b, c, d) {
			...
			return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
					...
					for (i && (t = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")), g && (u = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "multiBox", !1, "cbox")); x > z; ) {
						...
						for (r = a, a = w.p.idPrefix + a, i && (v = w.formatCol(0, 1, "", null, a, !0), f[f.length] = '<td role="gridcell" ' + t + " " + v + ">0</td>"), g && (l = '<input role="checkbox" type="checkbox" id="jqg_' + w.p.id + "_" + a + '" ' + u + "/>", v = w.formatCol(i, 1, "", null, a, !0), f[f.length] = '<td role="gridcell" ' + v + ">" + l + "</td>"), h && (f[f.length] = $(w).jqGrid("addSubGridCell", g + i, 1)), k = g + h + i; k < w.p.colModel.length; k++)
				...
				if (h.grid && h.p.cellEdit === !0) {
					...
					if (g = h.p.colModel[b], d = g.name, "subgrid" !== d && "cb" !== d && "rn" !== d) {
						if (f = $("td:eq(" + b + ")", h.rows[a]), g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b))
							parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [h.rows[a].id, d, e, a, b]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b);
						else {
							...
							$("input, select, textarea", f).bind("keydown", function (c) {
								if (27 === c.keyCode && ($("input.hasDatepicker", f).length > 0 ? $(".ui-datepicker").is(":hidden") ? $(h).jqGrid("restoreCell", a, b) : $("input.hasDatepicker", f).datepicker("hide") : $(h).jqGrid("restoreCell", a, b)), 13 === c.keyCode && !c.shiftKey)
					...
					if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
						...
						case "select":
							if (j.editoptions.multiple) {
								...
								g = $("#" + a + "_" + l + " option:selected", d.rows[a]).val(), h = $("#" + a + "_" + l + " option:selected", d.rows[a]).text();
							j.formatter && (h = g);
							break;
						case "checkbox":
							var p = ["Yes", "No"];
							j.editoptions && (p = j.editoptions.value.split(":")),
							g = $("#" + a + "_" + l, d.rows[a]).is(":checked") ? p[0] : p[1],
							h = g;
							break;
						case "password":
						case "text":
							...
							if (t[0] === !0) {
								...
								if ($.isFunction(d.p.beforeSubmitCell) && (v = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), v || (v = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)
									if (d.p.cellurl) {
										...
										j.editoptions && j.editoptions.NullIfEmpty && "" === g && (g = "null", u = !0),
										w[k] = g;
										var x,
										y,
										z;
										...
										$.ajax($.extend({
												...
												complete: function (c, j) {
													if ($(d).jqGrid("progressBar", {
														...
														l[0] === !0 ? (u && (g = ""), $(i).empty(), $(d).jqGrid("setCell", d.rows[a].id, b, h, !1, !1, !0), $(i).addClass("dirty-cell"), $(d.rows[a]).addClass("edited"), $(d).triggerHandler("jqGridAfterSaveCell", [d.rows[a].id, k, g, a, b]), $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b), d.p.savedRow.splice(0, 1)) : ($.jgrid.info_dialog(e.errcap, l[1], f.bClose, {
																styleUI: d.p.styleUI
												...
												error: function (c, g, h) {
													...
													$.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, c, g, h) : $.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, {
														styleUI: d.p.styleUI
													}),
													d.p.restoreCellonFail && $(d).jqGrid("restoreCell", a, b)
												}
	...
	$.extend($.jgrid, {
		...
		createModal: function (a, b, c, d, e, f, g) {
			...
			if ($.fn.jqm && c.jqModal === !0) {
				...
				0 === c.left && 0 === c.top || (p.left = c.left, p.top = c.top + "px");
			...
			if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({
				...
				if ($(m).css("cursor", "move"), $.fn.tinyDraggable)
					$(l).tinyDraggable({
			...
			if (c.resize)
				if ($.fn.jqResize)
					$(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : !1);
				else
					try {
						$(l).resizable({
							handles: "se, sw",
		...
		viewModal: function (a, b) {
			if (b = $.extend({
						...
						jqm: !0,
						jqM: !0
					}, b || {}), void 0 === b.focusField && (b.focusField = 0), "number" == typeof b.focusField && b.focusField >= 0 ? b.focusField = parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? b.focusField = 0 : b.focusField = !1, $.fn.jqm && b.jqm === !0)
		...
		info_dialog: function (a, b, c, d) {
			...
			if (e.buttons.length > 0)
				for (j = 0; j < e.buttons.length; j++)
					void 0 === e.buttons[j].id && (e.buttons[j].id = "info_button_" + j), k += "<a id='" + e.buttons[j].id + "' class='fm-button " + i.button + "'>" + e.buttons[j].text + "</a>";
				...
				if (b.multiple === !0 ? (k = !0, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = !1, null != b.dataUrl) {
					...
					$.ajax($.extend({
							...
							success: function (a) {
								...
								l && ($(d).append(l), f(d, g, n ? ["postData"] : void 0), void 0 === g.size && (g.size = i ? 3 : 1), i ? (c = e.split(","), c = $.map(c, function (a) {
												return $.trim(a)
					...
					k && (l = c.split(","), l = $.map(l, function (a) {
								return $.trim(a)
							})),
					...
					if ("string" == typeof b.value)
						...
						for (t = b.value, p = 0; p < t.length; p++)
							2 === t[p].length && (u = t[p][0], v = t[p][1], s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = v, g.appendChild(s), k || $.trim(u) !== $.trim(c) && $.trim(v) !== $.trim(c) || (s.selected = "selected"), k && ($.inArray($.trim(v), l) > -1 || $.inArray($.trim(u), l) > -1) && (s.selected = "selected"));
					else if ("object" == typeof b.value) {
						t = b.value;
						for (u in t)
							t.hasOwnProperty(u) && (s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = t[u], g.appendChild(s), k || $.trim(u) !== $.trim(c) && $.trim(t[u]) !== $.trim(c) || (s.selected = "selected"), k && ($.inArray($.trim(t[u]), l) > -1 || $.inArray($.trim(u), l) > -1) && (s.selected = "selected"))
					}
					f(g, b, ["value"])
				}
				break;
		...
		checkValues: function (a, b, c, d) {
			...
			if (void 0 === c)
				...
				e = c, g = void 0 === d ? "_" : d;
			if (e) {
				if (g || (g = null != k.p.colNames ? k.p.colNames[b] : l[b].label), e.required === !0 && $.jgrid.isEmpty(a))
				...
				var o;
				if (e.email === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (o = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, o.test(a))))
					return [!1, g + ": " + m.email, ""];
				...
				if (e.date === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (l[b].formatoptions && l[b].formatoptions.newformat ? (h = l[b].formatoptions.newformat, j = $.jgrid.getRegional(k, "formatter.date.masks"), j && j.hasOwnProperty(h) && (h = j[h])) : h = l[b].datefmt || "Y-m-d", $.jgrid.checkDate(h, a))))
					return [!1, g + ": " + m.date + " - " + h, ""];
			...
			this.each(function () {
				...
				if (!c.p.filterToolbar) {
					...
					m = function (b, d, e) {
						...
						d = parseInt(d, 10),
						e = parseInt(e, 10) + 18;
						for (var f, i, k = $(".ui-jqgrid-view").css("font-size") || "11px", l = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + k + ";left:" + d + "px;top:" + e + 'px;">', m = $(b).attr("soper"), n = [], o = 0, p = $(b).attr("colname"), q = c.p.colModel.length; q > o && c.p.colModel[o].name !== p; )
							o++;
						...
						for (s.sopt || (s.sopt = [], s.sopt[0] = "select" === r.stype ? "eq" : a.defaultSearch), $.each(a.odata, function () {
							...
							i = $.inArray(s.sopt[o], n), -1 !== i && (f = m === a.odata[i].oper ? h.highlight : "", l += '<li class="ui-menu-item ' + f + '" role="presentation"><a class="' + h.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + a.odata[i].oper + '" oper="' + a.operands[a.odata[i].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + a.operands[a.odata[i].oper] + "</td><td>" + a.odata[i].text + "</td></tr></table></a></li>");
						l += "</ul>",
						$("body").append(l),
					...
					$.each(c.p.colModel, function (b) {
						...
						$(u).append(v),
						$(n).append(u),
						a.searchOperators || $("td:eq(0)", w).hide()
					}),
			...
			this.each(function () {
				...
				if (c.grid) {
					...
					if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0])
						...
						v = !1,
						a.tmplNames && a.tmplNames.length && (v = !0, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function (a, b) {
			...
			editGridRow: function (a, b) {
				...
				this.each(function () {
							...
							if (a.length) {
								...
								$.each(q.p.colModel, function () {
									if (this.name === d && this.editoptions && $.isFunction(this.editoptions.custom_value)) {
										try {
											if (s[d] = this.editoptions.custom_value.call(q, $("#" + $.jgrid.jqID(d), y), "get"), void 0 === s[d])
												throw "e1"
										} catch (a) {
								...
								case "select-multiple":
									s[this.name] = $(this).val(),
									s[this.name] ? s[this.name] = s[this.name].join(",") : s[this.name] = "";
									var f = [];
					...
					function d(a, b, c, d) {
								...
								if (f = this.name, g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
									...
									if ("_empty" === a && s.defaultValue && (i = $.isFunction(s.defaultValue) ? s.defaultValue.call(q) : s.defaultValue), this.edittype || (this.edittype = "text"), q.p.autoencode && (i = $.jgrid.htmlDecode(i)), k = $.jgrid.createEl.call(q, this.edittype, s, i, !1, $.extend({}, $.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {})), "select" === this.edittype && (i = $(k).val(), "select-multiple" === $(k).get(0).type && i && (i = i.join(","))), "checkbox" === this.edittype && (i = $(k).is(":checked") ? $(k).val() : $(k).attr("offval")), (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[f] = i), $(k).addClass("FormElement"), $.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && $(k).addClass(e.inputClass), D)
										$(J)
											...
											"custom" === this.edittype && $.isFunction(s.custom_value) && s.custom_value.call(q, $("#" + f, w), "set", i),
											$.jgrid.bindEv.call(q, k, s),
											n[m] = l,
											m++
										}
									}), m > 0) {
						...
						function g(a, b, c) {
							...
							if ("_empty" === a)
								return $(k).each(function () {
									...
									f = $("#" + $.jgrid.jqID(d), c),
									f && f.length && null !== f[0] && (h = "", "custom" === this.edittype && $.isFunction(g.custom_value) ? g.custom_value.call(q, $("#" + d, c), "set", h) : g.defaultValue ? (h = $.isFunction(g.defaultValue) ? g.defaultValue.call(q) : g.defaultValue, "checkbox" === f[0].type ? (i = h.toLowerCase(), i.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== i ? (f[0].checked = !0, f[0].defaultChecked = !0, f[0].value = h) : (f[0].checked = !1, f[0].defaultChecked = !1)) : f.val(h)) : "checkbox" === f[0].type ? (f[0].checked = !1, f[0].defaultChecked = !1, h = $(f).attr("offval")) : f[0].type && "select" === f[0].type.substr(0, 6) ? f[0].selectedIndex = 0 : f.val(h), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = h))
								}), void $("#id_g", c).val(a);
									...
									if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
										...
										case "checkbox":
											if (e = String(e), k[f].editoptions && k[f].editoptions.value) {
												...
												e = e.toLowerCase(), e.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== e ? ($("#" + d, c)[q.p.useProp ? "prop" : "attr"]("checked", !0), $("#" + d, c)[q.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : ($("#" + d, c)[q.p.useProp ? "prop" : "attr"]("checked", !1), $("#" + d, c)[q.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
						...
						function i() {
							...
							o && "object" == typeof o && (s = o),
							$.isFunction(rp_ge[q.p.id].beforeCheckValues) && (o = rp_ge[q.p.id].beforeCheckValues.call(q, s, $(w), u), o && "object" == typeof o && (s = o));
							for (e in s)
								if (s.hasOwnProperty(e) && (l = $.jgrid.checkValues.call(q, s[e], e), l[0] === !1))
									break;
							if (h(), l[0] && (m = $(q).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[q.p.id], s, u]), void 0 === m && $.isFunction(rp_ge[q.p.id].onclickSubmit) && (m = rp_ge[q.p.id].onclickSubmit.call(q, rp_ge[q.p.id], s, u) || {}), l = $(q).triggerHandler("jqGridAddEditBeforeSubmit", [s, $(w), u]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[q.p.id].beforeSubmit) && (l = rp_ge[q.p.id].beforeSubmit.call(q, s, $(w), u))), l[0] && !rp_ge[q.p.id].processing) {
								...
								var t = $.extend({
										...
										complete: function (e, h) {
											...
											if ($("#sData", y + "_2").removeClass(f.active), s[c] = q.p.idPrefix + s[c], e.status >= 300 && 304 !== e.status ? (l[0] = !1, l[1] = $(q).triggerHandler("jqGridAddEditErrorTextFormat", [e, u]), $.isFunction(rp_ge[q.p.id].errorTextFormat) ? l[1] = rp_ge[q.p.id].errorTextFormat.call(q, e, u) : l[1] = h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(q).triggerHandler("jqGridAddEditAfterSubmit", [e, s, u]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[q.p.id].afterSubmit) && (l = rp_ge[q.p.id].afterSubmit.call(q, e, s, u))), l[0] === !1)
												...
												for (j in rp_ge[q.p.id]._savedData)
													rp_ge[q.p.id]._savedData.hasOwnProperty(j) && s[j] && (rp_ge[q.p.id]._savedData[j] = s[j]);
								...
								if (t.url || rp_ge[q.p.id].useDataProxy || ($.isFunction(q.p.dataProxy) ? rp_ge[q.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + E.nourl)), l[0])
									if (rp_ge[q.p.id].useDataProxy) {
										...
										void 0 === x && (x = [!0, ""]),
										x[0] === !1 ? (l[0] = !1, l[1] = x[1] || "Error deleting the selected row!") : (t.data.oper === n.addoper && rp_ge[q.p.id].closeAfterAdd && $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
												gb: "#gbox_" + $.jgrid.jqID(v),
												jqm: b.jqModal,
												onClose: rp_ge[q.p.id].onClose,
												removemodal: rp_ge[q.p.id].removemodal,
										...
										"clientArray" === t.url ? (rp_ge[q.p.id].reloadAfterSubmit = !1, s = t.data, t.complete({
												status: 200,
												statusText: ""
											}, "")) : $.ajax(t)
							}
						...
						function k() {
							...
							rp_ge[q.p.id].checkOnUpdate && (s = {}, c(), t = j(s, rp_ge[q.p.id]._savedData), t && ($(w).data("disabled", !0), $(".confirm", "#" + z.themodal).show(), a = !1)),
							a
						}
						function l() {
							var b;
						...
						if (q.grid && a) {
							...
							if (D ? (G = o(rp_ge[$(this)[0].p.id].template), r = y) : (G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>"), r = y + "_2"), w = "#" + $.jgrid.jqID(w), $(J).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(J).append("<div class='tinfo topinfo'>" + rp_ge[q.p.id].topinfo + "</div>"), $(q.p.colModel).each(function () {
								...
								if (D ? ($(J).find("#pData").replaceWith(N), $(J).find("#nData").replaceWith(O), $(J).find("#sData").replaceWith(P), $(J).find("#cData").replaceWith(Q), U = $("<div id=" + x + "></div>").append(J)) : U = $("<div></div>").append(J).append(R), $(J).append("<div class='binfo topinfo bottominfo'>" + rp_ge[q.p.id].bottominfo + "</div>"), $.jgrid.createModal(z, U, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(q.p.id), $("#gbox_" + $.jgrid.jqID(q.p.id))[0]), K && ($("#pData, #nData", y + "_2").css("float", "right"), $(".EditButton", y + "_2").css("text-align", "left")), rp_ge[q.p.id].topinfo && $(".tinfo", w).show(), rp_ge[q.p.id].bottominfo && $(".binfo", w).show(), U = null, R = null, $("#" + $.jgrid.jqID(z.themodal)).keydown(function (a) {
										var c = a.target;
										if ($(w).data("disabled") === !0)
											return !1;
										if (rp_ge[q.p.id].savekey[0] === !0 && a.which === rp_ge[q.p.id].savekey[1] && "TEXTAREA" !== c.tagName)
											return $("#sData", y + "_2")
												.trigger("click"), !1;
											if (27 === a.which)
												return k() ? (T && $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
														gb: b.gbox,
														jqm: b.jqModal,
														onClose: rp_ge[q.p.id].onClose,
														removemodal: rp_ge[q.p.id].removemodal,
											...
											if (rp_ge[q.p.id].navkeys[0] === !0) {
												...
												if (a.which === rp_ge[q.p.id].navkeys[1])
													return $("#pData", r).trigger("click"), !1;
												if (a.which === rp_ge[q.p.id].navkeys[2])
													return $("#nData", r).trigger("click"), !1
											}
										...
										var V = b.zIndex || 999;
										V++,
										$("<div class='" + b.overlayClass + " jqgrid-overlay confirm' style='z-index:" + V + ";display:none;'>&#160;</div><div class='confirm ui-jqconfirm " + f.content + "' style='z-index:" + (V + 1) + "'>" + b.saveData + "<br/><br/>" + P + O + Q + "</div>").insertAfter(w),
								...
								$("#sData", r).click(function () {
									...
									$(".FormError", w).hide(),
									c(),
									"_empty" === s[q.p.id + "_id"] ? i() : b.checkOnSubmit === !0 ? (t = j(s, rp_ge[q.p.id]._savedData), t ? ($(w).data("disabled", !0), $(".confirm", "#" + $.jgrid.jqID(z.themodal)).show()) : i()) : i(),
									!1
								}),
								...
								$("#nData", r).click(function () {
									...
									if (a[0] = parseInt(a[0], 10), -1 !== a[0] && a[1][a[0] + 1]) {
										...
										var c;
										if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(q, "next", $(w), a[1][a[0]]), void 0 !== c && c === !1))
											return !1;
								...
								$("#pData", r).click(function () {
									...
									if (-1 !== a[0] && a[1][a[0] - 1]) {
										...
										var c;
										if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(q, "prev", $(w), a[1][a[0]]), void 0 !== c && c === !1))
											return !1;
										if ($("#" + $.jgrid.jqID(a[1][a[0] - 1])).hasClass(f.disabled))
											return !1;
										g(a[1][a[0] - 1], q, w),
								...
								$("#" + p.themodal).keydown(function (a) {
									...
									if (b.navkeys[0] === !0) {
										if (a.which === b.navkeys[1])
											return $("#pData", "#" + m + "_2").trigger("click"), !1;
										if (a.which === b.navkeys[2])
											return $("#nData", "#" + m + "_2").trigger("click"), !1
									}
								}),
					...
					this.each(function () {
						...
						if (c.grid && a) {
							...
							if (rp_ge[c.p.id].styleUI = c.p.styleUI || "jQueryUI", $.isArray(a) && (a = a.join()), void 0 !== $("#" + $.jgrid.jqID(r.themodal))[0]) {
								if (l && (o = l.call(c, $("#" + p)), void 0 === o && (o = !0)), o === !1)
									return;
								$("#DelData>td", "#" + p).text(a),
								$("#DelError", "#" + p).hide(),
								...
								if (u += "<table class='EditTable ui-common-table' id='" + p + "_2'><tbody><tr><td><hr class='" + f.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + v + "&#160;" + w + "</td></tr></tbody></table>", b.gbox = "#gbox_" + $.jgrid.jqID(m), $.jgrid.createModal(r, u, rp_ge[c.p.id], "#gview_" + $.jgrid.jqID(c.p.id), $("#gview_" + $.jgrid.jqID(c.p.id))[0]), l && (o = l.call(c, $(u)), void 0 === o && (o = !0)), o === !1)
									return;
									...
									if (n = {}, $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
										...
										var k = $.extend({
												...
												complete: function (a, g) {
													var h;
													if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, $.isFunction(rp_ge[c.p.id].errorTextFormat) ? e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a) : e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === !1)
						...
						if (!this.p.navGrid) {
							...
							if (o.grid && "string" == typeof a) {
								...
								for (m.cloneToTop && o.p.toppager && (q = 2), p = 0; q > p; p++) {
									...
									$("#testpg2").remove(),
									o.p._nvtd && (m.dropmenu ? (w = null, $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g)) : j > o.p._nvtd[0] ? (o.p.responsive ? (w = null, $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g)) : $(u + "_" + m.position, u).append(w).width(j), o.p._nvtd[0] = j) : $(u + "_" + m.position, u).append(w), o.p._nvtd[1] = j),
									o.p.navGrid = !0
								}
					...
					return this.each(function () {
						...
						r = function () {
							...
							c.add && (e = e || {}, a = e.id || "add_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.addtext || c.addtitle) + "</a></li>").click(function () {
										return $(this).hasClass(m.disabled) || ($.isFunction(c.addfunc) ? c.addfunc.call(i) : $(i).jqGrid("editGridRow", "new", e), $(o).hide()),
										!1
									}), $(o).append(j)),
							c.edit && (d = d || {}, a = d.id || "edit_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.edittext || c.edittitle) + "</a></li>").click(function () {
							...
							c.view && (h = h || {}, a = h.id || "view_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.viewtext || c.viewtitle) + "</a></li>").click(function () {
										if (!$(this).hasClass(m.disabled)) {
											var a = i.p.selrow;
							...
							c.del && (f = f || {}, a = f.id || "del_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.deltext || c.deltitle) + "</a></li>").click(function () {
										if (!$(this).hasClass(m.disabled)) {
											var a;
							...
							c.search && (g = g || {}, a = g.id || "search_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.searchtext || c.searchtitle) + "</a></li>").click(function () {
										return $(this).hasClass(m.disabled) || ($.isFunction(c.searchfunc) ? c.searchfunc.call(i, g) : $(i).jqGrid("searchGrid", g), $(o).hide()),
										!1
									}), $(o).append(j), g.showOnLoad && g.showOnLoad === !0 && $(j).click()),
							c.refresh && (a = g.id || "search_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.refreshtext || c.refreshtitle) + "</a></li>").click(function () {
										if (!$(this).hasClass(m.disabled)) {
				...
				groupingPrepare: function (a, b) {
					return this.each(function () {
						...
						l = 0;
						for (c = 0; k > c; c++)
							d = h.groupField[c], f = h.displayField[c], e = a[d], g = null == f ? null : a[f], null == g && (g = e), void 0 !== e && (0 === b ? (h.groups.push({
										idx: c,
										dataIndex: d,
										value: e,
										displayValue: g,
					...
					return this.each(function () {
						...
						if (m.hasClass(i)) {
							if (c.showSummaryOnHide) {
								if (l)
									for (; l && (f = n(l.className), !(void 0 !== f && e >= f)); )
										$(l).hide(), l = l.nextSibling, q && ($(s).hide(), s = s.nextSibling)
							} else if (l)
								for (; l && (f = n(l.className), !(void 0 !== f && e >= f)); )
									$(l).hide(), l = l.nextSibling, q && ($(s).hide(), s = s.nextSibling);
					...
					return this.each(function () {
						...
						$.each(k.groups, function (e, u) {
							...
							if (x) {
								...
								for (k._locgr && (B = (c - 1) * d, B > u.startRow && (C = B)), y = C; D > y && a[y - B]; y++)
									l += a[y - B].join("");
					...
					this.each(function () {
						...
						for ($(p).prepend(w), d = $("<tr>", {
							...
							if (f = t[b].el, g = $(f), c = r[b], h = {
								...
								for (j = a.groupHeaders[i], k = j.numberOfColumns, l = j.titleText, n = j.className || "", m = 0, i = 0; k > i && s > b + i; i++)
									r[b + i].hidden || m++;
								e = $("<th>").attr({
										role: "columnheader"
					...
					if (b = $.extend({
						...
						if (g.grid) {
							if (d = $(g).data("inlineNav"), d && g.p.inlineNav && $(g).jqGrid("setGridParam", {
									...
									f += b.outerHTML
								}), $.isFunction(b.beforeSetItem) && (c = b.beforeSetItem.call(g, e), null != c && (e = c)), b.compression && b.compressionModule)
								try {
						...
						if (b) {
							...
							if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
								...
								d.filterToolbar && h && (m.jqGrid("setGridParam", {
										filterToolbar: !1
									}), h.restoreFromFilters = !0, m.jqGrid("filterToolbar", h)),
						...
						if (this.grid) {
							...
							if (d.rownumbers && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.multiselect && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.subGrid && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.knv = null, d.treeGrid)
								for (c in d.treeReader)
									d.treeReader.hasOwnProperty(c) && (d.colNames.splice(d.colNames.length - 1), d.colModel.splice(d.colModel.length - 1));
							switch (a.exptype) {
							case "xmlstring":
									...
									if (y = j.p.colModel[a], k = y.name, "cb" !== k && "subgrid" !== k && y.editable === !0 && "rn" !== k && !$(this).hasClass("not-editable-cell")) {
										...
										case "select":
											if (y.editoptions.multiple) {
												...
												q[k] = $("select option:selected", this).val(), r[k] = $("select option:selected", this).text();
										...
										if (n = $.jgrid.checkValues.call(j, q[k], a), n[0] === !1)
											return !1;
										...
										complete: function (b, c) {
											if ($(j).jqGrid("progressBar", {
												...
												if (d = $(j).triggerHandler("jqGridInlineSuccessSaveRow", [b, a, i]), $.isArray(d) || (d = [!0, s]), d[0] && $.isFunction(i.successfunc) && (d = i.successfunc.call(j, b)), $.isArray(d) ? (f = d[0], q = d[1] || q) : f = d, f === !0) {
													...
													$(j).triggerHandler("jqGridInlineErrorSaveRow", [a, b, c, null, i]), $.isFunction(i.errorfunc) && i.errorfunc.call(j, a, b, c, null), i.restoreAfterError === !0 && $(j).jqGrid("restoreRow", a, i.afterrestorefunc)
											}
										},
										error: function (b, c, d) {
											if ($("#lui_" + $.jgrid.jqID(j.p.id)).hide(), $(j).triggerHandler("jqGridInlineErrorSaveRow", [a, b, c, d, i]), $.isFunction(i.errorfunc))
						...
						if (this.grid) {
							...
							if (void 0 === c && (c = !0), c)
								if (a.rowID = $.isFunction(a.rowID) ? a.rowID.call(b, a) : null != a.rowID ? a.rowID : $.jgrid.randId(), a.useDefValues === !0 && $(b.p.colModel).each(function () {
									...
									}), $(b).jqGrid("addRowData", a.rowID, a.initdata, a.position), a.rowID = b.p.idPrefix + a.rowID, $("#" + $.jgrid.jqID(a.rowID), "#" + $.jgrid.jqID(b.p.id)).addClass("jqgrid-new-row"), a.useFormatter)
		...
		gridDnD: function (a) {
			return this.each(function () {
				...
				if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
					...
					if (void 0 === $("#jqgrid_dnd")[0] && $("body").append(f), "string" == typeof a && "updateDnD" === a && e.p.jqgdnd === !0)
						return void b();
					if (a = $.extend({
								drag: function (a) {
									return $.extend({
										start: function (b, c) {
											...
											stop: function (b, c) {
												var d,
												f;
												for (c.helper.dropped && !a.dragcopy && (f = $(c.helper).attr("id"), void 0 === f && (f = $(this).attr("id")), $(e).jqGrid("delRowData", f)), d = 0; d < $.data(e, "dnd").connectWith.length; d++)
			...
			return this.each(function () {
				...
				function m(a, b, c, d) {
					...
					for ($.isArray(c) ? (j = c.length, n = c) : (j = 1, n[0] = c), f = [], g = [], f.root = 0, d._count ? d._count++ : d._count = 1, i = 0; j > i; i++) {
						...
						for (e = 0; k > e; e++) {
							if (null == c)
								h = $.trim(b[e].member) + "_" + b[e].aggregator, o = h, n[0] = b[e].label || b[e].aggregator + " " + $.trim(b[e].member);
							else {
								o = c[i].replace(/\s+/g, "");
								try {
							...
							d[h] = p[h] = l(b[e].aggregator, d[h], b[e].member, a, d._count)
						}
						m += c[i].replace(/\s+/g, ""),
						f[h] = p,
						g[h] = n[i]
				...
				for (var A = r - 1, B = {}; w > x; ) {
					...
					q = 0;
					do
						C[q] = $.trim(o[j.xDimension[q].dataName]), u[j.xDimension[q].dataName] = C[q], q++;
					while (r > q);
					var E = 0;
					if (p = -1, v = b(d, k, C)) {
						if (p >= 0) {
							if (E = 0, s >= 1) {
								for (E = 0; s > E; E++)
									D[E] = $.trim(o[j.yDimension[E].dataName]), j.yDimension[E].converter && $.isFunction(j.yDimension[E].converter) && (D[E] = j.yDimension[E].converter.call(this, D[E], C, D));
				...
				if (j.colTotals)
					for (var N = d.length; N--; )
						for (q = r; q < c.length; q++)
							M = c[q].name, e[M] ? e[M] += parseFloat(d[N][M] || 0) : e[M] = parseFloat(d[N][M] || 0);
				if (A > 0)
					for (q = 0; A > q; q++)
						c[q].isGroupField && (h.groupingView.groupField.push(c[q].name), h.groupingView.groupSummary.push(j.groupSummary), h.groupingView.groupSummaryPos.push(j.groupSummaryPos));
				else
					h.grouping = !1;
				h.sortname = c[A].name,
		...
		jqPivot: function (a, b, c, d) {
			return this.each(function () {
				function e(a) {
					...
					i.groupOptions.sortname && h && (e = b.xDimension[h - 1].sortorder ? b.xDimension[h - 1].sortorder : "asc", g = b.xDimension[h - 1].sorttype ? b.xDimension[h - 1].sorttype : "text", k.orderBy(i.groupOptions.sortname, e, g, "", g)),
		...
		setSubGrid: function () {
			return this.each(function () {
				...
				if (c.p.subGridOptions = $.extend(e, c.p.subGridOptions || {}), c.p.colNames.unshift(""), c.p.colModel.unshift({
					...
					for (a[0].align = $.extend([], a[0].align || []), b = 0; b < a[0].name.length; b++)
				...
				if (c.grid) {
						...
						if ($(m).append(n), a && (h = c.p.jsonReader.subgrid, e = $.jgrid.getAccessor(a, h.root), void 0 !== e))
							for (f = 0; f < e.length; f++) {
								if (g = e[f], n = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), h.repeatitems === !0)
									for (h.cell && (g = g[h.cell]), l = 0; l < g.length; l++)
										k(n, g[l] || "&#160;", l);
								else {
					...
					n = function (a) {
						...
						if (b = $(a).attr("id"), d = {
							...
							}, d[c.p.prmNames.subgridid] = b, !c.p.subGridModel[0])
							return !1;
					...
					for (void 0 !== b && b > 0 && (q = b, p = b + 1); p > q; )
						$(c.rows[q]).hasClass("jqgrow") && (c.p.scroll && $(c.rows[q].cells[a]).unbind("click"), $(c.rows[q].cells[a]).bind("click", function () {
								...
								if (e = c.p.id, d = b.id, h = $("#" + e + "_" + d + "_expandedContent"), $(this).hasClass("sgcollapsed")) {
									if (g = $(c).triggerHandler("jqGridSubGridBeforeExpand", [e + "_" + d, d]), g = g !== !1 && "stop" !== g, g && $.isFunction(c.p.subGridBeforeExpand) && (g = c.p.subGridBeforeExpand.call(c, e + "_" + d, d)), g === !1)
										return !1;
									...
									if (g = $(c).triggerHandler("jqGridSubGridRowColapsed", [e + "_" + d, d]), g = g !== !1 && "stop" !== g, g && $.isFunction(c.p.subGridRowColapsed) && (g = c.p.subGridRowColapsed.call(c, e + "_" + d, d)), g === !1)
										return !1;
			...
			return this.each(function () {
				if (this.grid && this.p.treeGrid)
					for (var c = $(this).jqGrid("getNodeParent", a); c; )
						b.push(c), c = $(this).jqGrid("getNodeParent", c)
			}),
			b
		},
		...
		SortTree: function (a, b, c, d) {
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					for (h = $.jgrid.from.call(this, l), h.orderBy(a, b, c, d), i = h.select(), e = 0, f = i.length; f > e; e++)
						g = i[e], j.push(g), $(this).jqGrid("collectChildrenSortTree", j, g, a, b, c, d);
					$.each(j, function (a) {
			...
			return this.each(function () {
				if (this.grid && this.p.treeGrid && e)
					for (c = this.p.localReader.id, b = 0; e > b; b++)
						f = $(this).jqGrid("getNodeAncestors", a[b]), f.length || f.push(a[b]), d = f[f.length - 1][c], -1 === $.inArray(d, g) && (g.push(d), f = $(this).jqGrid("getFullTreeNode", f[f.length - 1], !0), h = h.concat(f))
			}),
			h
		},
			...
			if (c) {
				...
				if (void 0 === d && (d = !1), null == a) {
					if (j = e.p.data.length - 1, j >= 0)
						for (; j >= 0; )
							u = Math.max(u, parseInt(e.p.data[j][e.p.localReader.id], 10)), j--;
					a = u + 1
				}
				var w = $(e).jqGrid("getInd", b);
				if (l = !1, void 0 === b || null === b || "" === b)
					b = null, v = null, f = "last", i = e.p.tree_root_level, j = e.p.data.length + 1;
				else {
					f = "after",
					g = e.p._index[b],
					h = e.p.data[g],
				...
				if (k = j + 1, void 0 === c[n] && (c[n] = !1), void 0 === c[t] && (c[t] = !1), c[p] = i, void 0 === c[o] && (c[o] = !0), "adjacency" === e.p.treeGridModel && (c[q] = b), "nested" === e.p.treeGridModel) {
					...
					if (null !== b) {
						if (m = parseInt(h[s], 10), y = $.jgrid.from.call(e, e.p.data), y = y.greaterOrEquals(s, m, {
							...
							for (A in z)
								z.hasOwnProperty(A) && (z[A][r] = z[A][r] > m ? parseInt(z[A][r], 10) + 2 : z[A][r], z[A][s] = z[A][s] >= m ? parseInt(z[A][s], 10) + 2 : z[A][s]);
						c[r] = m,
						c[s] = m + 1
					} else {
			...
			if ($.fmatter.isNumber(a) || (a *= 1), $.fmatter.isNumber(a)) {
				...
				if ($.fmatter.isNumber(b.decimalPlaces)) {
					...
					if (e = String(Math.round(a * h) / h), c = e.lastIndexOf("."), g > 0)
						for (0 > c ? (e += f, c = e.length - 1) : "." !== f && (e = e.replace(".", f)); e.length - 1 - c < g; )
							e += "0"
				}
				if (b.thousandsSeparator) {
					...
					l = -1;
					for (j = c; j > 0; j--)
						l++, l % 3 === 0 && j !== c && (!d || j > 1) && (k = i + k), k = e.charAt(j - 1) + k;
					e = k
				}
	...
	$.fn.fmatter.actions = function (a, b) {
		...
		if (void 0 !== b.colModel.formatoptions && (d = $.extend(d, b.colModel.formatoptions)), void 0 === e || $.fmatter.isEmpty(e))
			return "";
