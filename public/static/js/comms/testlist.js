...
jQuery(function($) {
	 ...
	 * $(grid_selector).closest('.tab-pane').width(); $(grid_selector).jqGrid(
	 * 'setGridWidth', parent_width ); }) //and also set width when tab pane
	 * becomes visible $('#myTab a[data-toggle="tab"]').on('shown.bs.tab',
	 * function (e) { if($(e.target).attr('href') == '#mygrid') { var
	 * parent_width = $(grid_selector).closest('.tab-pane').width();
