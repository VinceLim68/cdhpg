		...
		from: function (source) {
			...
			QueryObject = function (d, q) {
				...
				this._append = function (a) {
					var
					b;
					for (null === _query ? _query = "" : _query += "" === _queuedOperator ? " && " : _queuedOperator, b = 0; b < _orDepth; b++)
						_query += "(";
					_negate && (_query += "!"),
					_query += "(" + a + ")",
					_negate = !1,
				...
				this._compare = function (a, b, c) {
					...
					void
					0 === b && (b = null),
					null === a && null === b ? 0 : null === a && null !== b ? 1 : null !== a && null === b ? -1 : "[object Date]" === d.call(a) && "[object Date]" === d.call(b) ? a < b ? -c : a > b ? c : 0 : (_usecase || "number" == typeof
						a || "number" == typeof
		...
		return this.each(function () {
			...
			b(a, b, c, d) {
				if (e.p.multiselect && e.p.multiboxonly || e.p.multimail)
					if (b)
						...
						if (e.p.multiboxonly && e.p.multimail)
							$(e).triggerHandler("jqGridSelectRow", [a, !1, c]), e.p.onSelectRow && e.p.onSelectRow.call(e, a, !1, c);
						else {
							var
			...
			if (!this.grid) {
				...
				B = function (a, b, c, d, g, h) {
					...
					0 === b ? m += "width: " + f.headers[a].width + "px;" : ($.isFunction(k.cellattr) || "string" == typeof
						...
						j && (j = j.replace(/style/i, "style").replace(/title/i, "title"), j.indexOf("title") > -1 && (k.title = !1), j.indexOf("class") > -1 && (n = void
									0), p = j.replace(/\-style/g, "-sti").split(/style/), 2 === p.length ? (p[1] = $.trim(p[1].replace(/\-sti/g, "-style").replace("=", "")), 0 !== p[1].indexOf("'") && 0 !== p[1].indexOf('"') || (p[1] = p[1].substring(1)), m += p[1].replace(/'/gi, '"')) : m += '"')),
					p.length || (p[0] = "", m += '"'),
					m += (void
						0 !== n ? ' class="' + n + '"' : "") + (k.title && c ? ' title="' + $.jgrid.stripHtml(c) + '"' : ""),
				...
				H = function (a) {
					...
					for (c = 0; c < e.p.colModel.length; c++)
						b = e.p.colModel[c], "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (d[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name, !1 !== e.p.keyName && !0 === b.key && (e.p.keyName = d[f], e.p.keyIndex = f), f++);
					return d
				},
				I = function (a) {
					var
							...
							for (c = n[a], f = $.jgrid.getAccessor(c, d), void
								0 === f && ("number" == typeof
									...
									0 === f && (f = t + a, r && (g = $.jgrid.getAccessor(c, r) || c, f = null != g && void
												0 !== g[d] ? g[d] : f, g = null))), i = {}, i[p.id] = f, r && (c = $.jgrid.getAccessor(c, r) || c), l = $.isArray(c) ? j : k, b = 0; b < l.length; b++)
				...
				L = function () {
					...
					c,
					d = e.p.data.length;
					for (a = !1 === e.p.keyName || !0 === e.p.loadonce ? e.p.localReader.id : e.p.keyName, e.p._index = [], b = 0; b < d; b++)
						c = $.jgrid.getAccessor(e.p.data[b], a), void
				...
				M = function (a, b, c, d, f) {
					...
					if ("object" != typeof
						...
						k.hasOwnProperty("id") && (a = k.id, delete
							k.id),
						k.hasOwnProperty("tabindex") && (h = k.tabindex, delete
							k.tabindex),
						k.hasOwnProperty("style") && (j += k.style, delete
							k.style),
						k.hasOwnProperty("class") && (c += " " + k.class, delete
							k.class);
						try {
							delete
							k.role
				...
				N = function (a, b, c, d) {
					...
					if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
						...
						$.isFunction(i.userdata) ? e.p.userData = i.userdata.call(e, a) || {}
							...
							for (var
								...
								if (D.push(""), z && D.push(G(0, P, e.p.page, e.p.rowNum, W)), x && D.push(F(u, z, P, !1, X)), y && D.push(p.call(v, x + z, P + b)), i.repeatitems) {
									...
									for (k = 0; k < B.length; k++)
										o = $.jgrid.getXmlData(t, B[k]), C[e.p.colModel[k + x + y + z].name] = o, D.push(E(u, o, k + x + y + z, P + b, t, C));
						...
						if (!0 === e.p.gridview && (n = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? g || (v.jqGrid("groupingRender", Q, e.p.colModel.length, e.p.page, R), Q = null) : !0 === e.p.treeGrid && n > 0 ? $(e.rows[n]).after(D.join("")) : (T.append(D.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new
								Date - f, D = null, !0 === e.p.subGrid)
							try {
								v.jqGrid("addSubGrid", x + z)
							} catch (a) {}
						if (w > 0 && 0 === e.p.records && (e.p.records = O), !0 === e.p.treeGrid)
							try {
						...
						if (e.p.reccount = w, e.p.treeANode = -1, e.p.userDataOnFooter && v.jqGrid("footerData", "set", e.p.userData, !0), g && (e.p.records = O, e.p.lastpage = Math.ceil(O / R)), c || e.updatepager(!1, !0), g) {
							for (; w < O; ) {
								if (t = L[w], u = r(t, w + S), u = e.p.idPrefix + u, i.repeatitems) {
									...
									for (k = 0; k < B.length; k++)
										o = $.jgrid.getXmlData(t, B[k]), C[e.p.colModel[k + x + y + z].name] = o;
				...
				O = function (a, b, c, d) {
					...
					if (a) {
						...
						j && (e.p.data = [], e.p._index = {}, e.p.localReader.id = i),
						e.p.reccount = 0,
						...
						D && (r = $.jgrid.getMethod("addSubGridCell")),
						...
						var
						R,
						S = parseInt(e.p.rowNum, 10),
						T = e.p.scroll ? $.jgrid.randId() : 1,
						U = !1;
						d && (S *= d + 1),
						"local" !== e.p.datatype || e.p.deselectAfterSort || (U = !0);
						var
						V,
						...
						for (e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, V = $.jgrid.getMethod("groupingPrepare")); n < t; ) {
							...
							x = e.p.idPrefix + x,
							U && (R = e.p.multiselect ? -1 !== $.inArray(x, e.p.selarrrow) : x === e.p.selrow);
							var
							ca = P.length;
							for (P.push(""), K && P.push(G(0, n, e.p.page, e.p.rowNum, _)), C && P.push(F(x, K, n, R, aa)), D && P.push(r.call(y, C + K, n + b)), s = N, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = L)), p = 0; p < s.length; p++)
								k = $.jgrid.getAccessor(q, s[p]), O[e.p.colModel[p + C + D + K].name] = k, P.push(E(x, k, p + C + D + K, n + b, q, O));
							if (P[ca] = M(x, Y, R ? Q + " " + o : Q, O, q), P.push("</tr>"), e.p.grouping && (X.push(P), e.p.groupingView._locgr || V.call(y, O, n), P = []), (j || !0 === e.p.treeGrid && !e.p._ald) && (O[i] = $.jgrid.stripPref(e.p.idPrefix, x), e.p.data.push(O), e.p._index[O[i]] = e.p.data.length - 1), !1 === e.p.gridview && (Z.append(P.join("")), y.triggerHandler("jqGridAfterInsertRow", [x, O, q]), W && e.p.afterInsertRow.call(e, x, O, q), P = []), O = {}, z++, n++, z === S)
								break
						}
						if (!0 === e.p.gridview && (w = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? j || (y.jqGrid("groupingRender", X, e.p.colModel.length, e.p.page, S), X = null) : !0 === e.p.treeGrid && w > 0 ? $(e.rows[w]).after(P.join("")) : (Z.append(P.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new
								Date - f, P = null, !0 === e.p.subGrid)
							try {
								y.jqGrid("addSubGrid", C + K)
							} catch (a) {}
						if (z > 0 && 0 === e.p.records && (e.p.records = t), !0 === e.p.treeGrid)
							try {
						...
						if (e.p.reccount = z, e.p.treeANode = -1, e.p.userDataOnFooter && y.jqGrid("footerData", "set", e.p.userData, !0), j && (e.p.records = t, e.p.lastpage = Math.ceil(t / S)), c || e.updatepager(!1, !0), j) {
							for (; z < t && u[z]; ) {
								...
								if (q) {
									for (x = e.p.idPrefix + x, s = N, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = L)), p = 0; p < s.length; p++)
										O[e.p.colModel[p + C + D + K].name] = $.jgrid.getAccessor(q, s[p]);
									O[i] = $.jgrid.stripPref(e.p.idPrefix, x),
									e.p.grouping && V.call(y, O, z),
									e.p.data.push(O),
									e.p._index[O[i]] = e.p.data.length - 1,
									O = {}
								}
								z++
							}
						...
						if (null != a.rules)
							try {
								for (f = a.rules.length && "OR" === a.groupOp.toString().toUpperCase(), f && s.orBegin(), c = 0; c < a.rules.length; c++)
									h = a.rules[c], g = a.groupOp.toString().toUpperCase(), r[h.op] && h.field && (j > 0 && g && "OR" === g && (s = s.or()), i = k[h.field], "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(e, i.newfmt, h.data, i.srcfmt)), s = r[h.op](s, g)(h.field, h.data, k[h.field])), j++;
								f && s.orEnd()
							} catch (a) {
								alert(a)
							}
							...
							for (C = 0; C < y; C++) {
								if (E)
									for (D
										in
										e.p.userData)
										e.p.userData.hasOwnProperty(D) && (e.p.userData[D] += parseFloat(w[C][D] || 0));
								F.call($(e), w[C], C, x)
							}
						}
				...
				Q = function (a, b) {
					...
					if (o = e.p.pager || "", o += e.p.toppager ? o ? "," + e.p.toppager : e.p.toppager : "") {
						if (j = $.jgrid.getRegional(e, "formatter.integer"), c = A(e.p.page), d = A(e.p.lastpage), $(".selbox", o)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), e.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", o).val(e.p.page), k = e.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, j) : e.p.lastpage)), e.p.viewrecords)
							if (0 === e.p.reccount)
								$(".ui-paging-info", o).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords));
							else {
								g = f + 1,
								i = e.p.records,
				...
				V = function (a) {
					if (!e.grid.hDiv.loading) {
						...
						if (!1 === p || "stop" === p)
							return;
						if ($.isFunction(e.p.beforeRequest) && (!1 === (p = e.p.beforeRequest.call(e)) || "stop" === p))
							return;
						...
						case "xmlstring":
							if (R(), c = "string" != typeof
									e.p.datastr ? e.p.datastr : $.parseXML(e.p.datastr), !T(c, 200, null))
								return void
								S();
							N(c),
							U(c, h);
						...
						case "jsonstring":
							if (R(), c = "string" == typeof
									e.p.datastr ? $.jgrid.parse(e.p.datastr) : e.p.datastr, !T(c, 200, null))
								return void
								S();
							O(c),
							U(c, h);
				...
				X = function (a, b) {
					...
					if (a = a.substr(1), b += "_" + a, c = "pg_" + a, d = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + l(m, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + d + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), e.p.rowList.length > 0) {
						t = '<td dir="' + i + '">',
						t += "<select " + l(m, "pgSelectBox", !1, "ui-pg-selbox") + ' role="listbox" title="' + ($.jgrid.getRegional(e, "defaults.pgrecs", e.p.pgrecs) || "") + '">';
						var
						v;
						for (k = 0; k < e.p.rowList.length; k++)
							v = e.p.rowList[k].toString().split(":"), 1 === v.length && (v[1] = v[0]), t += '<option role="option" value="' + v[0] + '"' + (A(e.p.rowNum, 0) === A(v[0], 0) ? ' selected="selected"' : "") + ">" + v[1] + "</option>";
						t += "</select></td>"
					}
					...
					!0 === e.p.pgbuttons && ($(".ui-pg-button", "#" + c).hover(function () {
							...
							!!u(this.id.split("_")[0], this) && (this.id === "first" + b && f && (e.p.page = 1, d = !0), this.id === "prev" + b && g && (e.p.page = a - 1, d = !0), this.id === "next" + b && h && (e.p.page = a + 1, d = !0), this.id === "last" + b && i && (e.p.page = c, d = !0), d && V(), !1)
						})),
				...
				Y = function (a, b, c) {
					...
					void
					0 === c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : "asc-desc" !== f[a].lso && "desc-asc" !== f[a].lso || (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc" : f[a].lso = h = c,
					h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(n), $(g).attr("aria-selected", "true")) : e.p.viewsortcols[0] || $("span.s-ico", g).hide();
					var
					i = u.indexOf(d);
					-1 === i ? (u.push(d), v.push(h)) : h ? v[i] = h : (v.splice(i, 1), u.splice(i, 1)),
					e.p.sortorder = "",
					e.p.sortname = "";
					for (var
						j = 0, k = u.length; j < k; j++)
						j > 0 && (e.p.sortname += ", "), e.p.sortname += u[j], j !== k - 1 && (e.p.sortname += " " + v[j]);
					e.p.sortorder = v[k - 1]
				},
				Z = function (a, b, c, d, f) {
					if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
						if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc" : "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort)
							Y(b, f, d);
						else {
							if (d) {
				...
				_ = function () {
					...
					!0 === e.p.shrinkToFit && i > 0 && (c = f.width - h * i - l, isNaN(e.p.height) || (c -= j, k = !0), g = 0, $.each(e.p.colModel, function (d) {
				...
				da = function (a, b, c) {
					...
					$.fn.html5sortable() && $("#col_menu").html5sortable({
						...
						for (i.splice(b.startindex, 1), i.splice(b.endindex, 0, b.startindex), $(e).jqGrid("destroyFrozenColumns"), $(e).jqGrid("remapColumns", i, !0), $(e).jqGrid("setFrozenColumns"), d = 0; d < h; d++)
							i[d] = d
					}),
				...
				ea = function (a, b, c, d) {
					...
					if (k) {
						...
						x += '<div><select id="oper1" class="' + s.filter_select + '">',
						...
						x = $("<div></div>").append(A),
						j.append(x),
						x = '<div><select id="operand" class="' + s.filter_select + '">',
						$.each(h, function (a, b) {
						...
						x = '<div><select id="oper2" class="' + s.filter_select + '">' + r + "</select></div>",
						j.append(x),
						y = q || "",
						z = $.extend(k.searchoptions, {
								name: k.index || k.name,
						...
						j = $('<ul id="search_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="left:' + c + "px;top:" + b + 'px;"></ul>').append(j),
						$(d).append(j),
				...
				ia = function (a, b, c) {
					...
					d,
					f,
					g = $(".ui-jqgrid-view").css("font-size") || "11px",
					...
					$("#column_menu > li > a").hover(function () {
						...
						b,
						c;
						"columns" === $(this).attr("value") && (b = $(this).parent().width() + 18, c = $(this).parent().position().top - 5, da(c, b, $(this).parent())),
						"filtering" === $(this).attr("value") && (b = $(this).parent().width() + 18, c = $(this).parent().position().top - 5, ea(a, c, b, $(this).parent())),
						$(this).addClass(p)
					}, function () {
						$(this).removeClass(p)
					}).click(function () {
						...
						"sortasc" === b ? Z("jqgh_" + e.p.id + "_" + i.name, a, !0, "asc", c) : "sortdesc" === b ? Z("jqgh_" + e.p.id + "_" + i.name, a, !0, "desc", c) : "grouping" === b ? ga(a, d) : "freeze" === b && ha(a, f),
				...
				for (e.p.colMenu && $("body").on("click", function (a) {
					...
					}), this.p.id = this.id, -1 === $.inArray(e.p.multikey, z) && (e.p.multikey = !1), e.p.keyName = !1, j = 0; j < e.p.colModel.length; j++)
					y = "string" == typeof
						e.p.colModel[j].template ? null != $.jgrid.cmTemplate && "object" == typeof
						$.jgrid.cmTemplate[e.p.colModel[j].template] ? $.jgrid.cmTemplate[e.p.colModel[j].template] : {}
				 : e.p.colModel[j].template,
				e.p.colModel[j] = $.extend(!0, {}, e.p.cmTemplate, y || {}, e.p.colModel[j]),
				...
				qa,
				ra,
				sa = "<thead><tr class='ui-jqgrid-labels' role='row'>",
				ta = "",
				ua = "",
				va = "";
				...
				if ("horizontal" === e.p.viewsortcols[1] ? (ua = " ui-i-asc", va = " ui-i-desc") : "single" === e.p.viewsortcols[1] && (ua = " ui-single-sort-asc", va = " ui-single-sort-desc", ta = " style='display:none'", e.p.viewsortcols[0] = !1), ja = t ? "class='ui-th-div-ie'" : "", qa = "<span class='s-ico' style='display:none'>", qa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + ua + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_asc", !0) + "'" + ta + "></span>", qa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + va + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_desc", !0) + "'" + ta + "></span></span>", e.p.multiSort && e.p.sortname)
					for (u = e.p.sortname.split(","), j = 0; j < u.length; j++)
						w = $.trim(u[j]).split(" "), u[j] = $.trim(w[0]), v[j] = w[1] ? $.trim(w[1]) : e.p.sortorder || "asc";
				for (j = 0; j < this.p.colNames.length; j++) {
					var
					wa = e.p.headertitles ? ' title="' + $.jgrid.stripHtml(e.p.colNames[j]) + '"' : "";
					ra = e.p.colModel[j],
					ra.hasOwnProperty("colmenu") || (ra.colmenu = "rn" !== ra.name && "cb" !== ra.name && "subgrid" !== ra.name),
					sa += "<th id='" + e.p.id + "_" + ra.name + "' role='columnheader' " + l(m, "headerBox", !1, "ui-th-column ui-th-" + i) + " " + wa + ">",
					ka = ra.index || ra.name,
					sa += "<div class='ui-th-div' id='jqgh_" + e.p.id + "_" + ra.name + "' " + ja + ">" + e.p.colNames[j],
					ra.width ? ra.width = parseInt(ra.width, 10) : ra.width = 150,
					"boolean" != typeof
					ra.title && (ra.title = !0),
					ra.lso = "",
					ka === e.p.sortname && (e.p.lastsort = j),
					e.p.multiSort && -1 !== (w = $.inArray(ka, u)) && (ra.lso = v[w]),
					sa += qa,
					e.p.colMenu && ra.colmenu && (sa += "<a class='colmenu' href='#/'><span class='colmenuspan " + r + " " + s.icon_menu + "'></span></a>"),
					sa += "</div></th>"
				}
				if (sa += "</tr></thead>", qa = null, ra = null, $(this).append(sa), $("thead tr:first th", this).hover(function () {
					...
					$("#cb_" + $.jgrid.jqID(e.p.id), this).on("click", function () {
						...
						this.checked ? ($(e.rows).each(function (b) {
							...
							}), e.p.selrow = null, xa = !1),
						$(e).triggerHandler("jqGridSelectAll", [xa ? e.p.selarrrow : ya, xa]),
						$.isFunction(e.p.onSelectAll) && e.p.onSelectAll.call(e, xa ? e.p.selarrrow : ya, xa)
					})
				}
				if (!0 === e.p.autowidth) {
					var
				...
				if (e.p.disableClick = !1, $("th", Ba).each(function (a) {
						...
						la = ra.width,
						void
						0 === ra.resizable && (ra.resizable = !0),
						ra.resizable ? (ma = document.createElement("span"), $(ma).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + i).css("cursor", "col-resize"), $(this).addClass(e.p.resizeclass)) : ma = "",
						$(this).css("width", la + "px").prepend(ma),
						ma = null;
						var
						b = "";
						ra.hidden && ($(this).css("display", "none"), b = "display:none;"),
						Ca += "<td role='gridcell' style='height:0px;width:" + la + "px;" + b + "'></td>",
						f.headers[a] = {
							width: la,
							el: this
						},
						...
						ta && (e.p.multiSort ? e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), e.tmpcm.lso && $("div span.ui-icon-" + ra.lso, this).removeClass(n).css("display", "")) : ra.lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + ra.lso, this).removeClass(n).css("display", "")) : e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === e.p.lastsort && $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", "")) : a === e.p.lastsort && "" !== e.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", ""))),
						e.p.footerrow && (Aa += "<td role='gridcell' " + B(a, 0, "", null, "", !1) + ">&#160;</td>")
					}).mousedown(function (a) {
						if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
							var
							b = ca(this);
							return !0 === e.p.forceFit && (e.p.nv = aa(b)),
							f.dragStart(b, a, ba(b)),
							!1
						}
					}).click(function (a) {
						if (e.p.disableClick)
							return e.p.disableClick = !1, !1;
						var
						b,
						c,
						...
						if (1 === f.length) {
							...
							null != g && Z($("div", this)[0].id, g, b, c, this),
							!1
						}
					}), ra = null, e.p.sortable && $.fn.sortable)
					try {
						$(e).jqGrid("sortableColumns", Ba)
					} catch (a) {}
				e.p.footerrow && (Aa += "</tr></tbody></table>"),
				Ca += "</tr>",
				pa = document.createElement("tbody"),
				this.appendChild(pa),
				$(this).addClass(l(m, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Ca),
				...
				f.hDiv.style.width = f.width - Ga + "px",
				f.hDiv.className = l(m, "headerDiv", !0, "ui-jqgrid-hdiv"),
				$(f.hDiv).append(Fa),
				$(Fa).append(Da),
				Da = null,
				Ea && $(f.hDiv).hide(),
				e.p.pager && ("string" == typeof
					e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({
						width: f.width + "px"
					}).addClass(l(m, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(x), Ea && $(e.p.pager).hide(), X(e.p.pager, "")),
				!1 === e.p.cellEdit && !0 === e.p.hoverrows && $(e).on({
					mouseover: function (a) {
						oa = $(a.target).closest("tr.jqgrow"),
						"ui-subgrid" !== $(oa).attr("class") && $(oa).addClass(p)
					},
					mouseout: function (a) {
						oa = $(a.target).closest("tr.jqgrow"),
						$(oa).removeClass(p)
				...
				$(e).before(f.hDiv).on({
					click: function (a) {
						if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 === $(oa).length || oa[0].className.indexOf(n) > -1 || ($(na, e).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== e.id)
							return this;
						var
						...
						if ("A" !== na.tagName && ("INPUT" !== na.tagName && "TEXTAREA" !== na.tagName && "OPTION" !== na.tagName && "SELECT" !== na.tagName || c))
							if (Ha = oa[0].id, na = $(na).closest("tr.jqgrow>td"), na.length > 0 && (Ia = $.jgrid.getCellIndex(na)), !0 !== e.p.cellEdit) {
									...
									if (e.p.multimail && e.p.multiselect) {
										if (a.shiftKey) {
											if (c) {
												...
												m = !1,
												o = !0;
												return $.inArray(Ha, e.p.selarrrow) > -1 && (o = !1),
								...
								if (e.p.multiselect && c && d)
									$(e).jqGrid("setSelection", Ha, !0, a);
								else
									if (na.length > 0)
										try {
					...
					reloadGrid: function (a, b) {
						...
						0 === b.page ? (delete
							e.p.lastpage, e.grid.populateVisible()) : e.grid.populate(),
					...
					contextmenu: function (a) {
						if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 !== $(oa).length) {
							e.p.multiselect || $(e).jqGrid("setSelection", oa[0].id, !0, a),
							Ha = oa[0].rowIndex,
							Ia = $.jgrid.getCellIndex(na);
							var
	...
	$.jgrid.extend({
		...
		resetSelection: function (a) {
			return this.each(function () {
				...
				!0 === d.p.cellEdit && parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && ($("td:eq(" + d.p.iCol + ")", d.rows[d.p.iRow]).removeClass("edit-cell " + f), $(d.rows[d.p.iRow]).removeClass("selected-row " + g)),
				d.p.savedRow = []
			})
		},
						...
						if ($(this.p.colModel).each(function (c) {
							...
							if (i.p.treeGrid)
								for (l
									...
									k[i.p.treeReader[l]];
							void
							0 !== n && (i.p.data[n] = $.extend(!0, i.p.data[n], k)),
							k = null
						}
					} catch (a) {
						f = !1
		...
		addRowData: function (a, b, c, d) {
			...
			return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
					...
					for (i && (s = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")), g && (t = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "multiBox", !1, "cbox")); x < w; ) {
						...
						for (q = a, a = v.p.idPrefix + a, i && (u = v.formatCol(0, 1, "", null, a, !0), f[f.length] = '<td role="gridcell" ' + s + " " + u + ">0</td>"), g && (l = '<input role="checkbox" type="checkbox" id="jqg_' + v.p.id + "_" + a + '" ' + t + "/>", u = v.formatCol(i, 1, "", null, a, !0), f[f.length] = '<td role="gridcell" ' + u + ">" + l + "</td>"), h && (f[f.length] = $(v).jqGrid("addSubGridCell", g + i, 1)), k = g + h + i; k < v.p.colModel.length; k++)
							p = v.p.colModel[k], e = p.name, z[e] = o[e], l = v.formatter(a, $.jgrid.getAccessor(o, e), k, o), u = v.formatCol(k, 1, l, o, a, z), f[f.length] = '<td role="gridcell" ' + u + ">" + l + "</td>";
						if (f.unshift(v.constructTr(a, !1, y, z, o)), f[f.length] = "</tr>", 0 === v.rows.length)
						...
						if (a = parseInt(a, 10), g.grid.width = g.p.width = a, $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $(g.grid.bDiv).css("width", a - n + "px"), $(g.grid.hDiv).css("width", a - n + "px"), g.p.pager && $(g.p.pager).css("width", a + "px"), g.p.toppager && $(g.p.toppager).css("width", a - n + "px"), !0 === g.p.toolbar[0] && ($(g.grid.uDiv).css("width", a - n + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a - n + "px")), g.p.footerrow && $(g.grid.sDiv).css("width", a - n + "px"), !1 === b && !0 === g.p.forceFit && (g.p.forceFit = !1), !0 === b) {
							...
							if ($.each(g.p.colModel, function (a) {
									if (!1 === this.hidden && !this.fixed) {
										if (c = this.widthOrg, (c = Math.round(e * c / (g.p.tblwidth - i * j - m))) < 0)
											return;
										this.width = c,
										h += c,
						...
						if ("" !== c || !0 === f) {
							...
							if (g = i.formatter(a, c, j, n, "edit"), h = i.p.colModel[j].title ? {
								...
								c = p.formatter && "string" == typeof
									p.formatter && "date" === p.formatter ? $.unformat.date.call(i, c, p) : c,
						...
						if (e >= 0 && f) {
							...
							if (a.p.groupHeader) {
								...
								$("tr.jqg-second-row-header th", n).each(function () {
									if (o = parseInt($(this).attr("colspan"), 10), p = parseInt($(this).attr("rowspan"), 10), p && (q++, r++), o && (q += o, r++), q === e)
										return r = e, !1
								}),
								q !== e && (r = e),
							...
							$(a).on("jqGridAfterGridComplete.setFrozenColumns", function () {
								...
								$(a.grid.fbDiv).height($(a.grid.bDiv).height() - 17);
								var
								b = [];
...
(function (a) {
			...
			if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
				...
				if (a.fmatter.isNumber(c.decimalPlaces)) {
					...
					if (f = String(Math.round(b * i) / i), d = f.lastIndexOf("."), h > 0)
						for (d < 0 ? (f += g, d = f.length - 1) : "." !== g && (f = f.replace(".", g)); f.length - 1 - d < h; )
							f += "0"
				}
	...
	a.fn.fmatter.checkbox = function (b, c) {
		...
		return void
		0 !== c.colModel && void
		0 !== c.colModel.formatoptions && (e = a.extend({}, e, c.colModel.formatoptions)),
		d = !0 === e.disabled ? 'disabled="disabled"' : "",
		(a.fmatter.isEmpty(b) || void
			0 === b) && (b = a.fn.fmatter.defaultFormat(b, e)),
		b = String(b),
		b = (b + "").toLowerCase(),
	...
	a.fn.fmatter.link = function (b, c) {
		...
		return void
		0 !== c.colModel && void
		0 !== c.colModel.formatoptions && (d = a.extend({}, d, c.colModel.formatoptions)),
	...
	a.fn.fmatter.date = function (b, c, d, e) {
		...
		return void
		0 !== c.colModel && void
		0 !== c.colModel.formatoptions && (f = a.extend({}, f, c.colModel.formatoptions)),
	...
	a.fn.fmatter.rowactions = function (b) {
		...
		void
		0 !== h.editOptions && (k.editOptions = h.editOptions),
		void
		0 !== h.delOptions && (k.delOptions = h.delOptions),
	...
	a.unformat.date = function (b, c) {
		...
		return void
		0 !== c.formatoptions && (d = a.extend({}, d, c.formatoptions)),
...
(function (a) {
	...
	a.extend(a.jgrid, {
		...
		createModal: function (b, c, d, e, f, g, h) {
			...
			m.appendChild(p),
			a(m).prepend(n),
			!0 === g ? a("body").append(m) : "string" == typeof
			g ? a(g).append(m) : a(m).insertBefore(e),
			a(m).css(h),
			void
			...
			if (d.resize)
				if (a.fn.jqResize)
					a(m).append("<div class='jqResize " + k.resizable + " " + l.icon_base + " " + k.icon_resizable + "'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", !!b.scrollelm && "#" + a.jgrid.jqID(b.scrollelm));
				else
					try {
						a(m).resizable({
							handles: "se, sw",
			...
			case "select":
				...
				if (!0 === c.multiple ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
												...
												if ("filter" === h.oper && a("#fbox_" + i.p.id)[0].p) {
													...
													a.each(p, function (a) {
														if (n = this.index || this.name, h.name === n)
															return this.searchoptions.dataUrl = null, this.searchoptions.value = l, !1
													})
												}
					...
					if (c.value) {
						...
						p;
						void
						0 === c.size && (c.size = l ? 3 : 1),
						l && (m = d.split(","), m = a.map(m, function (b) {
									return a.trim(b)
								})),
						"function" == typeof
						...
						if ("string" == typeof
							...
							for (q = c.value.split(x), p = 0; p < q.length; p++)
								r = q[p].split(w), r.length > 2 && (r[1] = a.map(r, function (a, b) {
											if (b > 0)
												return a
							...
							if ("[object Array]" === Object.prototype.toString.call(c.value))
								for (t = c.value, p = 0; p < t.length; p++)
									2 === t[p].length && (u = t[p][0], v = t[p][1], s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = v, h.appendChild(s), l || a.trim(u) !== a.trim(d) && a.trim(v) !== a.trim(d) || (s.selected = "selected"), l && (a.inArray(a.trim(v), m) > -1 || a.inArray(a.trim(u), m) > -1) && (s.selected = "selected"));
							else
								if ("object" == typeof
									c.value) {
									t = c.value;
									for (u
										in
										t)
										t.hasOwnProperty(u) && (s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = t[u], h.appendChild(s), l || a.trim(u) !== a.trim(d) && a.trim(t[u]) !== a.trim(d) || (s.selected = "selected"), l && (a.inArray(a.trim(t[u]), m) > -1 || a.inArray(a.trim(u), m) > -1) && (s.selected = "selected"))
								}
						g(h, c, ["value"])
					}
				break;
		...
		checkValues: function (b, c, d, e) {
			...
			if (void
				...
				f = d, h = void
					0 === e ? "_" : e;
			if (f) {
				if (h || (h = null != l.p.colNames ? l.p.colNames[c] : m[c].label), !0 === f.required && a.jgrid.isEmpty(b))
					return [!1, h + ": " + n.required, ""];
				var
				o = !1 !== f.required;
				if (!0 === f.number && (!1 !== o || !a.jgrid.isEmpty(b)) && isNaN(b))
					return [!1, h + ": " + n.number, ""];
				if (void
				...
				var
				p;
				if (!0 === f.email && !(!1 === o && a.jgrid.isEmpty(b) || (p = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, p.test(b))))
					return [!1, h + ": " + n.email, ""];
				...
				if (!0 === f.date && !(!1 === o && a.jgrid.isEmpty(b) || (m[c].formatoptions && m[c].formatoptions.newformat ? (i = m[c].formatoptions.newformat, (k = a.jgrid.getRegional(l, "formatter.date.masks")) && k.hasOwnProperty(i) && (i = k[i])) : i = m[c].datefmt || "Y-m-d", a.jgrid.checkDate(i, b))))
					return [!1, h + ": " + n.date + " - " + i, ""];
				if (!0 === f.time && !(!1 === o && a.jgrid.isEmpty(b) || a.jgrid.checkTime(b)))
					return [!1, h + ": " + n.date + " - hh:mm (am/pm)", ""];
				if (!0 === f.url && !(!1 === o && a.jgrid.isEmpty(b) || (p = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, p.test(b))))
					return [!1, h + ": " + n.url, ""];
		...
		editGridRow: function (c, d) {
			...
			this.each(function () {
					...
					if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
							if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
								if (!1 === r)
									...
									if (h === d.p.ExpandColumn && !0 === d.p.treeGrid)
								...
								if ("_empty" === c && t.defaultValue && (k = a.isFunction(t.defaultValue) ? t.defaultValue.call(s) : t.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, t, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
									...
									a("td:eq(" + (x - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void
											0 === v.label ? d.p.colNames[n] : v.label) + "</label>"),
				...
				k() {
					...
					q && "object" == typeof
					q && (u = q),
					a.isFunction(b[s.p.id].beforeCheckValues) && (q = b[s.p.id].beforeCheckValues.call(s, u, a(y), w)) && "object" == typeof
					q && (u = q);
					for (g
						in
						u)
						if (u.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(s, u[g], g), !1 === n[0]))
							break;
						...
						v = a.extend({
								...
								complete: function (g, j) {
									...
									if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void
											0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), !1 === n[0])
				...
				m() {
					...
					b[s.p.id].checkOnUpdate && (u = {}, e(), (v = l(u, s.p.savedData)) && (a(y).data("disabled", !0), a(".confirm", "#" + B.themodal).show(), c = !1)),
					c
				}
				function
				n() {
				...
				o(b, c) {
					...
					0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass(h.disabled) ? a("#pData", t).addClass(h.disabled) : a("#pData", t).removeClass(h.disabled),
					b === d ? a("#nData", t).addClass(h.disabled) : void
				...
				if (s.grid && c) {
					...
					if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function () {
						...
						if (F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), W = a("<div id=" + z + "></div>").append(L)) : W = a("<div></div>").append(L).append(T), a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>"), a.jgrid.createModal(B, W, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0]), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), W = null, T = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function (c) {
								var
								e = c.target;
								if (!0 === a(y).data("disabled"))
									return !1;
								if (!0 === b[s.p.id].savekey[0] && c.which === b[s.p.id].savekey[1] && "TEXTAREA" !== e.tagName)
									return a("#sData", A + "_2")
										.trigger("click"), !1;
									if (27 === c.which)
										return !!m() && (V && a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
												gb: d.gbox,
												jqm: d.jqModal,
												onClose: b[s.p.id].onClose,
												removemodal: b[s.p.id].removemodal,
								...
								X = d.zIndex || 999;
								X++,
								a("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + X + ";display:none;'>&#160;</div><div class='confirm ui-jqconfirm " + h.content + "' style='z-index:" + (X + 1) + "'>" + d.saveData + "<br/><br/>" + R + Q + S + "</div>").insertAfter(y),
						...
						a("#nData", t).click(function () {
							...
							if (c[0] = parseInt(c[0], 10), -1 !== c[0] && c[1][c[0] + 1]) {
								...
								if (a.isFunction(d.onclickPgButtons) && void
									0 !== (e = d.onclickPgButtons.call(s, "next", a(y), c[1][c[0]])) && !1 === e)
									return !1;
						...
						a("#pData", t).click(function () {
							...
							if (-1 !== c[0] && c[1][c[0] - 1]) {
								...
								e;
								if (a.isFunction(d.onclickPgButtons) && void
									0 !== (e = d.onclickPgButtons.call(s, "prev", a(y), c[1][c[0]])) && !1 === e)
									return !1;
								if (a("#" + a.jgrid.jqID(c[1][c[0] - 1])).hasClass(h.disabled))
									return !1;
								i(c[1][c[0] - 1], s, y),
		...
		viewGridRow: function (c, d) {
			...
			this.each(function () {
				...
				f(b, c, e, f) {
					...
					if (a(c.p.colModel).each(function () {
							...
							if (g = this.name, o = !1, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", p = "boolean" != typeof
								...
								a("td:eq(" + (m - 2) + ")", j[0]).html("<b>" + (void
										0 === d.label ? c.p.colNames[b] : d.label) + "</b>"),
				...
				j(b, c) {
					...
					0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass(h.disabled) ? a("#pData", o + "_2").addClass(h.disabled) : a("#pData", "#" + o + "_2").removeClass(h.disabled),
					b === d ? a("#nData", "#" + o + "_2").addClass(h.disabled) : void
				...
				if (l.grid && c) {
					...
					if (a(l.p.colModel).each(function () {
						...
						a.jgrid.createModal(r, G, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(l.p.id), a("#gview_" + a.jgrid.jqID(l.p.id))[0]),
						...
						a("#" + r.themodal).keydown(function (c) {
							if (27 === c.which)
								return b[l.p.id].closeOnEscape && a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {
									gb: d.gbox,
									jqm: d.jqModal,
									onClose: d.onClose,
				...
				if (e.grid && c) {
					...
					if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void
						...
						if (n = a(e).triggerHandler("jqGridDelRowBeforeInitData", [a("#" + o)]), void
							0 === n && (n = !0), n && a.isFunction(b[e.p.id].beforeInitData) && (n = b[e.p.id].beforeInitData.call(e, a("#" + o))), !1 === n)
							return;
						...
						if (t += "<table class='EditTable ui-common-table' id='" + o + "_2'><tbody><tr><td><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + u + "&#160;" + v + "</td></tr></tbody></table>", d.gbox = "#gbox_" + a.jgrid.jqID(l), a.jgrid.createModal(q, t, b[e.p.id], "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]), a(".fm-button", "#" + o + "_2").hover(function () {
								...
								if (m = {}, m = a(e).triggerHandler("jqGridDelRowClickSubmit", [b[e.p.id], n]), void
									...
									if (b[e.p.id].processing = !0, j = e.p.prmNames, f = a.extend({}, b[e.p.id].delData, m), k = j.oper, f[k] = j.deloper, i = j.id, n = String(n).split(","), !n.length)
										return !1;
									for (c
										in
										n)
										...
										p = a.extend({
												...
												complete: function (c, i) {
													...
													if (a("#dData", "#" + o + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, g[1] = a(e).triggerHandler("jqGridDelRowErrorTextFormat", [c]), a.isFunction(b[e.p.id].errorTextFormat) && (g[1] = b[e.p.id].errorTextFormat.call(e, c)), void
															...
															0 === g && (g = [!0, "", ""]), g[0] && a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f))), !1 === g[0])
														a("#DelError>td", "#" + o).html(g[1]), a("#DelError", "#" + o).show();
													else {
														if (b[e.p.id].reloadAfterSubmit && "local" !== e.p.datatype)
															...
															if (!0 === e.p.treeGrid)
																...
																for (j = 0; j < n.length; j++)
																	a(e).jqGrid("delRowData", e.p.idPrefix + n[j]);
															e.p.selrow = null,
															e.p.selarrrow = []
														}
					...
					if (p.grid && "string" == typeof
						...
						for (n.cloneToTop && p.p.toppager && (r = 2), q = 0; q < r; q++) {
							...
							n.search && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.searchicon + "'></span>" + n.searchtext + "</div>"), a("tr", x).append(u), a(u, x).attr({
									...
									!1
								}).hover(s, t), g.showOnLoad && !0 === g.showOnLoad && a(u, x).click(), u = null),
		...
		_buildNavMenu: function (b, c, d, e, f, g, h, i) {
			return this.each(function () {
				...
				(function () {
					...
					b,
					k,
					l = a(".ui-jqgrid-view").css("font-size") || "11px",
					...
					d.edit && (e = e || {}, b = e.id || "edit_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.edittext || d.edittitle) + "</a></li>").click(function () {
					...
					d.view && (i = i || {}, b = i.id || "view_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.viewtext || d.viewtitle) + "</a></li>").click(function () {
								if (!a(this).hasClass(n.disabled)) {
									var
									b = j.p.selrow;
					...
					d.del && (g = g || {}, b = g.id || "del_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.deltext || d.deltitle) + "</a></li>").click(function () {
								if (!a(this).hasClass(n.disabled)) {
									var
									b;
					...
					d.search && (h = h || {}, b = h.id || "search_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.searchtext || d.searchtitle) + "</a></li>").click(function () {
			...
			if (!this.filter) {
				...
				if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
					...
					this.createTableRowForRule = function (b, c) {
						...
						var
						s,
						t = a("<select class='" + i.srSelect + "'></select>"),
						u = [];
						r.append(t),
						t.on("change", function () {
							...
							if (l) {
								...
								for (u = [], a.each(n.p.ops, function () {
									 ...
									 - 1 !== (s = a.inArray(h[d], u)) && (0 === m && (b.op = n.p.ops[s].oper), j += "<option value='" + n.p.ops[s].oper + "'>" + n.p.ops[s].text + "</option>", m++);
						...
						for (y.append(A), A.on("change", function () {
							 ...
							 - 1 !== (s = a.inArray(h[d], u)) && (m = b.op === n.p.ops[s].oper ? " selected='selected'" : "", q += "<option value='" + n.p.ops[s].oper + "'" + m + ">" + n.p.ops[s].text + "</option>");
						A.append(q);
						var
						...
						a(z).addClass("input-elm " + i.srInput).on("change", function () {
					...
					this.toString = function () {
						...
						b(c) {
							...
							if (void
								0 !== c.groups)
								for (d = 0; d < c.groups.length; d++)
									e.length > 1 && ("OR" === c.groupOp ? e += " || " : e += " && "), e += b(c.groups[d]);
							if (void
								0 !== c.rules)
								for (d = 0; d < c.rules.length; d++)
									e.length > 1 && ("OR" === c.groupOp ? e += " || " : e += " && "), e += a(c.rules[d]);
							return e += ")",
							"()" === e ? "" : e
						}
						var
			...
			try {
				if (h = "string" == typeof
					...
					for (c = h.rules, d = 0; d < c.length; d++)
						e = c[d], a.inArray(e.filed, b.ssfield) && (f = e.data.split(b.splitSelect), f.length > 1 && (void
				...
				if (!d.p.filterToolbar) {
					...
					k = function () {
						...
						a.each(d.p.colModel, function () {
							...
							if (e = this.index || this.name, g = this.searchoptions || {}, f = b.searchOperators && g.searchOperMenu ? n.parent().prev().children("a").attr("soper") || b.defaultSearch : g.sopt ? g.sopt[0] : "select" === this.stype ? "eq" : b.defaultSearch, c = "custom" === this.stype && a.isFunction(g.custom_value) && n.length > 0 ? g.custom_value.call(d, n, "get") : n.val(), "select" === this.stype && g.multiple && a.isArray(c) && c.length && (k = !0, l.push(e), c = 1 === c.length ? c[0] : c), "bt" === f && (m = !0), c || "nu" === f || "nn" === f)
								h[e] = c, j[e] = f, i++;
							else
								try {
									delete
						...
						if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
							...
							if (k && a.jgrid.filterRefactor({
								...
								}), m && (a.isPlainObject(q) || (q = a.jgrid.parse(o)), q.rules && q.rules.length))
						...
						!y && a.isFunction(b.beforeSearch) && (y = b.beforeSearch.call(d)),
						y || a(d).jqGrid("setGridParam", {
							search: n
						}).trigger("reloadGrid", [{
									page: 1
								}
					...
					l = function (c) {
						...
						a.each(d.p.colModel, function () {
							...
							case "select":
								if (c.find("option").each(function (c) {
										if (0 === c && (this.selected = !0), a(this).val() === b)
						...
						!l && a.isFunction(b.beforeClear) && (l = b.beforeClear.call(d)),
					...
					m = function () {
						...
						!0 === d.p.frozenColumns && a(d).jqGrid("destroyFrozenColumns"),
					...
					n = function (c, e, f) {
						...
						f = parseInt(f, 10) + 18;
						for (var
							g, j, l = a(".ui-jqgrid-view").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + f + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; p < r && d.p.colModel[p].name !== q; )
							p++;
						var
						s = d.p.colModel[p],
						...
						for (t.sopt || (t.sopt = [], t.sopt[0] = "select" === s.stype ? "eq" : b.defaultSearch), a.each(b.odata, function () {
							 ...
							 - 1 !== (j = a.inArray(t.sopt[p], o)) && (g = n === b.odata[j].oper ? i.highlight : "", m += '<li class="ui-menu-item ' + g + '" role="presentation"><a class="' + i.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[j].oper + '" oper="' + b.operands[b.odata[j].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + b.operands[b.odata[j].oper] + "</td><td>" + b.odata[j].text + "</td></tr></table></a></li>");
						m += "</ul>",
						a("body").append(m),
					...
					b.restoreFromFilters && (g = d.p.postData.filters) && ("string" == typeof
						g && (g = a.jgrid.parse(g)), f = !!g.rules.length && g.rules),
		...
		refreshFilterToolbar: function (b) {
			...
			this.each(function () {
				...
				c(f) {
					if (f && f.rules) {
						for (g = f.rules, l = g.length, d = 0; d < l; d++)
							h = g[d], -1 !== (i = a.inArray(h.field, m)) && (e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(k[i].name)), e.length > 0 && ("select" === k[i].stype ? e.find("option[value='" + a.jgrid.jqID(h.data) + "']").prop("selected", !0) : "text" === k[i].stype && e.val(h.data), a.isFunction(b.onSetVal) && b.onSetVal.call(j, e, k[i].name)));
						if (f.groups)
							for (var
				...
				if (j.p.filterToolbar) {
					...
					"string" == typeof
					b.filters && b.filters.length && (f = a.jgrid.parse(b.filters)),
				...
				if (d.grid) {
					...
					if (b.styleUI = d.p.styleUI, "string" == typeof
						...
						if (b.showQuery && (u = "<a id='" + f + "_query' class='fm-button " + l.button + " fm-button-icon-left'><span class='" + l.icon_base + " " + k.icon_query + "'></span>Query</a>"), b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r, function (a, b) {
							...
							var
							A = "eq";
							x >= 0 && r[x].searchoptions && r[x].searchoptions.sopt ? A = r[x].searchoptions.sopt[0] : b.sopt && b.sopt.length && (A = b.sopt[0]),
							j = {
								groupOp: "AND",
								rules: [{
										field: p,
						...
						w = !1,
						b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
						...
						void
						0 === b.stringResult && (b.stringResult = b.multipleSearch),
						a("#" + f + "_search").on("click", function () {
							...
							if (e = a("#" + f), e.find(".input-elm:focus").change(), y && b.multipleSearch ? (d.p_savedFilter = {}, g = a.jgrid.filterRefactor({
											...
											splitSelect: b.splitSelect,
											groupOpSelect: b.groupOpSelect
										}), d.p_savedFilter = a.extend(!0, {}, e.jqFilter("filterData"))) : g = e.jqFilter("filterData"), b.errorcheck && (e[0].hideError(), b.showQuery || e.jqFilter("toSQLString"), e[0].p.error))
			...
			this.each(function () {
				...
				if (d.grid) {
					...
					if (b += "", "local" === d.p.datatype) {
						...
						!j && a.isFunction(c.beforeSearch) && (j = c.beforeSearch.call(d)),
	...
	a.jgrid.extend({
		editRow: function (b, c, d, e, f, g, h, i, j) {
			...
			return "object" === a.type(l[0]) ? k = l[0] : (void
					...
					0 !== f && (k.url = f), void
					0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)),
			k = a.extend(!0, {
					keys: !1,
					keyevent: "keydown",
					oneditfunc: null,
				...
				if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
					...
					"0" !== e || a(f).hasClass("not-editable-row") || (g = m.p.colModel, a('td[role="gridcell"]', f).each(function (e) {
							...
							if ("cb" !== c && "subgrid" !== c && "rn" !== c && (m.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[c] = d, !0 === g[e].editable)) {
								...
								"select" === g[e].edittype && void
								0 !== g[e].editoptions && !0 === g[e].editoptions.multiple && void
								0 === g[e].editoptions.dataUrl && a.jgrid.msie() && a(k).width(a(k).width()),
								i++
							}
		...
		saveRow: function (b, c, d, e, f, g, h) {
			...
			"object" === a.type(i[0]) ? j = i[0] : (a.isFunction(c) && (j.successfunc = c), void
					0 !== d && (j.url = d), void
					0 !== e && (j.extraparam = e), a.isFunction(f) && (j.aftersavefunc = f), a.isFunction(g) && (j.errorfunc = g), a.isFunction(h) && (j.afterrestorefunc = h)),
			j = a.extend(!0, {
					successfunc: null,
					url: null,
					extraparam: {},
			...
			if (void
				...
				if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
					...
					if (E = !1 === k.p.keyName ? F.id : k.p.keyName, r) {
						...
						void
						0 === k.p.inlineData && (k.p.inlineData = {}),
						r = a.extend({}, r, k.p.inlineData, j.extraparam)
					}
					if ("clientArray" === j.url) {
						r = a.extend({}, r, s),
						k.p.autoencode && a.each(r, function (b, c) {
				...
				if (this.grid && !this.p.inlineNav) {
					...
					c.add && a(d).jqGrid("navButtonAdd", b, {
						...
						onClickButton: function () {
							void
							0 === d.p.beforeAction && (d.p.beforeAction = !0),
					...
					!0 !== c.restoreAfterSelect && !0 !== c.saveAfterSelect || a(d).on("jqGridBeforeSelectRow.inlineNav", function (b, e) {
			...
			return this.each(function () {
				...
				if (i.grid && !0 === i.p.cellEdit) {
					...
					if (h = i.p.colModel[c], "subgrid" !== (e = h.name) && "cb" !== e && "rn" !== e) {
						...
						if (!0 !== h.editable || !0 !== d || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c))
							...
							a.inArray(h.edittype, ["text", "textarea", "password", "select"]) > -1 && a(o).addClass(l),
							g.html("").append(o).attr("tabindex", "0"),
							a.jgrid.bindEv.call(i, o, n),
							window.setTimeout(function () {
								a(o).focus()
							}, 1),
							a("input, select, textarea", g).on("keydown", function (d) {
						...
						case "custom":
							try {
								if (!k.editoptions || !a.isFunction(k.editoptions.custom_value))
									throw "e1";
								if (void
									0 === (h = k.editoptions.custom_value.call(e, a(".customelement", j), "get")))
									throw "e2";
								i = h
							} catch (b) {
						...
						if (i !== e.p.savedRow[d].v) {
							...
							if (!0 === t[0]) {
								...
								if (void
									...
									0 === (w = e.p.onSubmitCell(e.rows[b].id, l, h, b, c)) && (w = !0), !1 === w)
									return;
								if (a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)
									if (e.p.cellurl) {
										var
										x = {};
										e.p.autoencode && (h = a.jgrid.htmlEncode(h)),
										k.editoptions && k.editoptions.NullIfEmpty && "" === h && (h = "null", u = !0),
										x[l] = h;
										var
										y,
										z,
										...
										y = A.id,
										z = A.oper,
										x[y] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id),
										x[z] = A.editoper,
										x = a.extend(v, x),
			...
			return this.each(function () {
				...
				if (e.grid && !0 === e.p.cellEdit) {
					for (d = c + 1; d < e.p.colModel.length; d++)
						if (!0 === e.p.colModel[d].editable && (!a.isFunction(e.p.isCellEditable) || e.p.isCellEditable.call(e, e.p.colModel[d].name, b, d))) {
							f = d;
							break
						}
...
(function (a) {
	...
	a.fn.jqm = function (d) {
		...
		return this.each(function () {
			if (this._jqm)
				return c[this._jqm].c = a.extend({}, c[this._jqm].c, d);
			b++,
			this._jqm = b,
			c[b] = {
	...
	f = function (a) {
		void
		0 === a.c.focusField && (a.c.focusField = 0),
				...
				if (d.grid) {
					...
					m = function (b, c) {
						...
						b && (g = d.p.xmlReader.subgrid, a(g.root + " " + g.row, b).each(function () {
								if (i = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === g.repeatitems)
					...
					for (void
						0 !== c && c > 0 && (s = c, r = c + 1); s < r; )
						a(d.rows[s]).hasClass("jqgrow") && (d.p.scroll && a(d.rows[s].cells[b]).off("click"), q = null, t && (q = d.p.isHasSubGrid.call(d, d.rows[s].id)), !1 === q ? d.rows[s].cells[b].innerHTML = "" : a(d.rows[s].cells[b]).on("click", function () {
									var
									c = a(this).parent("tr")[0];
									if (f = d.p.id, e = c.id, i = a("#" + f + "_" + e + "_expandedContent"), a(this).hasClass("sgcollapsed")) {
										if (h = a(d).triggerHandler("jqGridSubGridBeforeExpand", [f + "_" + e, e]), h = !1 !== h && "stop" !== h, h && a.isFunction(d.p.subGridBeforeExpand) && (h = d.p.subGridBeforeExpand.call(d, f + "_" + e, e)), !1 === h)
											return !1;
										...
										if (a(this).hasClass("sgexpanded")) {
											if (h = a(d).triggerHandler("jqGridSubGridRowColapsed", [f + "_" + e, e]), h = !1 !== h && "stop" !== h, h && a.isFunction(d.p.subGridRowColapsed) && (h = d.p.subGridRowColapsed.call(d, f + "_" + e, e)), !1 === h)
												return !1;
											!0 === d.p.subGridOptions.reloadOnExpand ? i.remove(".ui-subgrid") : i.hasClass("ui-subgrid") && i.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"),
			...
			return this.each(function () {
					...
					for (i = g; i < c; i++) {
						...
						a.each(j.summary, function () {
							if (this.nm === l[i].name) {
								...
								return o = "<td " + k.formatCol(i, 1, "") + ">" + a.jgrid.template(p, h, j.cnt) + "</td>",
								!1
							}
						}),
						n += o
				...
				a.each(l.groups, function (f, v) {
					...
					if (w = a.isFunction(l.groupText[v.idx]) ? l.groupText[v.idx].call(k, j, v.cnt, v.summary) : a.jgrid.template(l.groupText[v.idx], j, v.cnt, v.summary), "string" != typeof
						...
						for (l._locgr && (A = (d - 1) * e) > v.startRow && (B = A), x = B; x < C && b[x - A]; x++)
							m += b[x - A].join("");
			...
			this.each(function () {
				...
				for (a(q).prepend(x), e = a("<tr>", {
					...
					if (g = u[c].el, h = a(g), d = s[c], i = {
						...
						for (k = b.groupHeaders[j], l = k.numberOfColumns, m = k.titleText, o = k.className || "", n = 0, j = 0; j < l && c + j < t; j++)
							s[c + j].hidden || n++;
						f = a("<th>").attr({
								role: "columnheader"
			...
			return this.each(function () {
				...
				if (d.grid && d.p.treeGrid) {
					...
					for (a(d).triggerHandler("jqGridBeforeSetTreeNode", [t, c]), a.isFunction(d.p.beforeSetTreeNode) && d.p.beforeSetTreeNode.call(d, t, c); b < c; ) {
						...
						void
						0 !== k[r] && ("true" === k[r] || !0 === k[r] ? k[r] = !0 : k[r] = !1),
						"true" === k[o] || !0 === k[o] ? (j += (void
								0 !== k[q] && "" !== k[q] ? k[q] : d.p.treeIcons.leaf) + " tree-leaf treeclick", k[o] = !0, l = "leaf") : (k[o] = !1, l = ""),
						k[n] = ("true" === k[n] || !0 === k[n]) && (k[r] || void
							0 === k[r]),
						...
						a(d.rows[b].cells[m]).find("div.treeclick").on("click", function (b) {
							var
		...
		expandRow: function (b) {
			this.each(function () {
				...
				if (c.grid && c.p.treeGrid) {
					...
					void
					0 === g && (g = !0),
					g && a.isFunction(c.p.beforeExpandTreeGridRow) && (g = c.p.beforeExpandTreeGridRow.call(c, f, b, d)),
				...
				if (d.grid && d.p.treeGrid)
					...
					case "nested":
						...
						a(this.p.data).each(function () {
							if (parseInt(this[g], 10) === j - 1 && parseInt(this[e], 10) < h && parseInt(this[f], 10) > i)
								return c = this, !1
						});
						break;
					case "adjacency":
			...
			return this.each(function () {
				...
				if (e.grid && e.p.treeGrid) {
					...
					case "nested":
						...
						n = parseInt(b[k], 10);
						for (f = 0; f < h; f++)
							(g = c ? e.p.data[e.p._index[this.rows[f].id]] : e.p.data[f]) && parseInt(g[k], 10) === n + 1 && parseInt(g[i], 10) > l && parseInt(g[j], 10) < m && d.push(g);
						break;
					case "adjacency":
						var
						...
						for (f = 0; f < h; f++)
							(g = c ? e.p.data[e.p._index[this.rows[f].id]] : e.p.data[f]) && String(g[o]) === String(a.jgrid.stripPref(e.p.idPrefix, b[p])) && d.push(g)
					}
				}
			}),
			d
		...
		reloadNode: function (b, c) {
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					void
					0 === c && (c = !1),
					c || jQuery._data(this, "events").jqGridAfterSetTreeNode || a(this).on("jqGridAfterSetTreeNode.reloadNode", function () {
						var
			...
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					if (!b[d]) {
						...
						if (void
							0 === m && (m = !0), m && a.isFunction(this.p.beforeExpandTreeGridNode) && (m = this.p.beforeExpandTreeGridNode.call(this, j, b)), !1 === m)
							return;
			...
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					if (b[c]) {
						...
						if (void
							0 === g && (g = !0), g && a.isFunction(this.p.beforeCollapseTreeGridNode) && (g = this.p.beforeCollapseTreeGridNode.call(this, e, b)), b[c] = !1, !1 === g)
							return;
		...
		SortTree: function (b, c, d, e) {
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					for (i = a.jgrid.from.call(this, m), i.orderBy(b, c, d, e), j = i.select(), f = 0, g = j.length; f < g; f++)
		...
		collectChildrenSortTree: function (b, c, d, e, f, g) {
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					l,
					m;
					for (k = a(this).jqGrid("getNodeChildren", c, this.p.search), l = a.jgrid.from.call(this, k), l.orderBy(d, e, f, g), m = l.select(), h = 0, i = m.length; h < i; h++)
								...
								if (a.level === u && "level" === d && u > 0)
									if (v > 1) {
										...
										for (b
											in
											a.fields)
											a.fields.hasOwnProperty(b) && (1 === n && k[u - 1].groupHeaders.push({
													startColumnName: b,
													numberOfColumns: 1,
				...
				for (var
					...
					if (r = -1, x = d(f, m, G)) {
						if (r >= 0) {
							if (I = 0, u >= 1) {
								for (I = 0; I < u; I++)
									H[I] = a.trim(q[l.yDimension[I].dataName]), l.yDimension[I].converter && a.isFunction(l.yDimension[I].converter) && (H[I] = l.yDimension[I].converter.call(this, H[I], G, H));
				...
				if (l.colTotals)
					for (var
						...
						for (s = t; s < e.length; s++)
							Q = e[s].name, g[Q] ? g[Q] += parseFloat(f[R][Q] || 0) : g[Q] = parseFloat(f[R][Q] || 0);
				if (D > 0)
					for (s = 0; s < D; s++)
			...
			if (c = a.extend({
				...
				if (h.grid) {
					...
					if (a.isFunction(c.beforeSetItem) && null != (d = c.beforeSetItem.call(h, f)) && (f = d), c.debug) {
						...
						a("#link_save").attr("href", k).on("click", function () {
							a(this).remove()
						})
					}
			...
			if (d = a.extend({
				...
				if (c) {
					...
					if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
						...
						e.datatype = "local",
						e.grouping = !1,
						e.inlineNav && (h = k(e._iN), e._iN = null, delete
							e._iN),
						e.filterToolbar && (i = k(e._fT), e._fT = null, delete
							e._fT);
						var
						m = a("#" + b).jqGrid(e);
						...
						if (e.treeGrid)
							for (var
								q = 1, r = m[0].rows.length, s = e.expColInd, t = e.treeReader.leaf_field, u = e.treeReader.expanded_field; q < r; )
								a(m[0].rows[q].cells[s]).find("div.treeclick").on("click", function (b) {
									var
									c = b.target || b.srcElement,
		...
		exportToCsv: function (b) {
			...
			if (this.each(function () {
					...
					d(b, c) {
							...
							for (i = g; i < l; i++)
								if (!k[i].hidden) {
									...
									a.each(m.summary, function () {
										if (this.nm === k[i].name) {
											k[i].summaryTpl && (q = k[i].summaryTpl),
											"string" == typeof
						...
						n,
						o,
						p = a.makeArray(g.groupSummary);
						return p.reverse(),
						a.each(g.groups, function (d, l) {
							m++;
							try {
							...
							if (r = "header" === g.groupSummaryPos[l.idx] ? e(d, 0, g.groups, 0) : new
								...
								for (s = x; s < y && b[s - w]; s++) {
									for (u = b[s - w], o = 0, t = 0; t < k.length; t++)
										k[t].hidden || (r[o] = a.jgrid.formatCellCsv(a.jgrid.formatCell(u[k[t].name], t, u, k[t], j), c), o++);
									...
									if ("header" !== g.groupSummaryPos[l.idx]) {
										...
										for (t = 0; t < m; t++)
											p[t] && (r = e(d, t, g.groups, 0), f += r.join(c.separator) + c.newLine);
										m = z
									}
								}
							}),
						...
						if (a.each(m, function (c, d) {
								void
								0 === d.exportcol && (d.exportcol = !0),
								"cb" !== d.name && "rn" !== d.name || d.hidden || (w.push(c), d.hidden = !0),
								d.exportcol || d.hidden || (y.push(c), d.hidden = !0),
								!d.hidden && d.exportcol && (v.push(a.jgrid.formatCellCsv(o[c], b)), x.push(d.name))
						...
						if (b.includeGroupHeader && j.p.groupHeader && j.p.groupHeader.length) {
							...
							for (e = 0; e < z.length; e++) {
								...
								for (p = 0, g = [], i = 0; i < x.length; i++) {
									for (g[p] = "", h = 0; h < A.length; h++)
										A[h].startColumnName === x[i] && (g[p] = a.jgrid.formatCellCsv(A[h].titleText, b));
									p++
								}
						...
						if (b.includeFooter && j.p.footerrow) {
							...
							if (B.length) {
								...
								for (e = 0, p = 0, g = []; e < C.cells.length; ) {
									...
									D.hidden || "_cb" === E || "_rn" === E || (g[p] = a.jgrid.formatCellCsv(a(D).text(), b), p++),
									e++
								}
								t += g.join(b.separator) + b.newLine
							}
						}
						for (c = r + s + u + q + t, e = 0; e < w.length; e++)
							m[w[e]].hidden = !1;
			...
			this.each(function () {
				...
				s = function (c, d) {
					...
					for (var
						...
						if (null == l && (l = ""), d || (l = "" !== l ? a.jgrid.formatCell(l, o.map[e], c, m[o.map[e]], g) : l), o.width[e] = Math.max(o.width[e], Math.min(parseInt(l.length, 10), b.maxlength)), "number" == typeof
							l || l.match && a.trim(l).match(/^-?\d+(\.\d+)?$/) && !a.trim(l).match(/^0\d+/))
				...
				if (a("sheets sheet", l.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && g.p.groupHeader && g.p.groupHeader.length) {
					...
					for (a("worksheet", j).append(D), n = 0; n < w.length; n++)
						D.appendChild(a.jgrid.makeNode(j, "mergeCell", {
								attr: w[n]
							}))
				}
				...
				if (b.includeFooter || g.p.footerrow) {
					...
					for (n
						in
						o.footer)
						o.footer.hasOwnProperty(n) && (o.footer[n] = a.jgrid.stripHtml(o.footer[n]));
					s(o.footer, !0),
					a("row:last c", j).attr("s", "2")
				}
				var
				G = a.jgrid.makeNode(j, "cols");
				for (a("worksheet", j).prepend(G), n = 0, f = o.width.length; n < f; n++)
					G.appendChild(a.jgrid.makeNode(j, "col", {
							attr: {
								min: n + 1,
								max: n + 1,
								width: o.width[n],
				...
				try {
					...
					a.jgrid.xmlToZip(H, l),
					H.generateAsync ? H.generateAsync(I).then(function (c) {
						a.jgrid.saveAs(c, b.fileName, {
							type: b.mimetype
						})
			...
			this.each(function () {
				...
				if (b.includeLabels && i.push(p), h.p.grouping)
					...
					for (n = 0, e = l.length; n < e; n++) {
						for (g = 0, p = [], v = l[n], f = 0; f < m.length; f++)
							k = {
					...
					if (7 !== a.nodeType) {
						...
						if (a.attributes && a.attributes.length)
							for (b = {}, c = 0; c < a.attributes.length; c++)
								"string" == typeof(d = a.attributes[c].nodeName) && (e = a.attributes[c].nodeValue) && (d = o.attr_prefix + d, void
						...
						if (a.childNodes && a.childNodes.length) {
							...
							if (g)
								...
								for (b || (b = {}), c = 0; c < a.childNodes.length; c++)
									"string" == typeof(d = a.childNodes[c].nodeName) && (e = parseElement(a.childNodes[c])) && (void
										0 === f[d] && (f[d] = 0), f[d]++, addNode(b, d, f[d], e))
						}
						return b
					}
	...
	$.jgrid.extend({
		...
		columnChooser: function (a) {
			...
			d() {
				...
				b[0].style ? b[0].style.width = "" : b.css("width", ""),
										...
										start: function (b, c) {
											...
											for (d = 0; d < $.data(e, "dnd").connectWith.length; d++)
												0 === $($.data(e, "dnd").connectWith[d])
													.jqGrid("getGridParam", "reccount") && $($.data(e, "dnd").connectWith[d]).jqGrid("addRowData", "jqg_empty_row", {});
											...
											drop: function (b, c) {
												if ($(c.draggable).hasClass("jqgrow")) {
													...
													if (!a.dropbyname) {
														...
														try {
															for (h
																in
																e)
																e.hasOwnProperty(h) && (g = k[i].name, "cb" !== g && "rn" !== g && "subgrid" !== g && e.hasOwnProperty(h) && k[i] && (j[g] = e[h]), i++);
															e = j
														} catch (a) {}
													}
													...
													if (c.helper.dropped) {
														var
														m;
														a.autoid && ($.isFunction(a.autoid) ? m = a.autoid.call(this, e) : (m = Math.ceil(1e3 * Math.random()), m = a.autoidprefix + m)),
														$("#" + $.jgrid.jqID(this.id)).jqGrid("addRowData", m, e, a.droppos)
													}
	...
	a.fn.html5sortable = function (d) {
		...
		this.each(function () {
			...
			if (/^enable|disable|destroy$/.test(e))
				return f = a(this).children(a(this).data("items")).attr("draggable", "enable" === e), void("destroy" === e && f.add(this).removeData("connectWith items").off("dragstart.h5s dragend.h5s selectstart.h5s dragover.h5s dragenter.h5s drop.h5s"));
			var
			g,
			h;
