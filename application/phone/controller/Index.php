...
//         dump($res);
    ...
    public function boxPlot(){
        ...
        $getPrice_result['Q0'] = ($getPrice_result['Q0']-$getPrice_result['min'])*$unit;
        ...
        $getPrice_result['Q4'] = ($getPrice_result['Q4']-$getPrice_result['min'])*$unit;
