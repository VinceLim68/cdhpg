...
class BelongsTo extends OneToOne {
	...
	public function getRelation($subRelation = '', $closure = null) {
		...
		$relationModel = $this->query->where ( $this->localKey, $this->parent->$foreignKey )->relation ( $subRelation )->find ();
	...
	public function hasWhere($where = []) {
		...
		return $this->parent->db ()->alias ( $model )->field ( $model . '.*' )->join ( $table . ' ' . $relation, $model . '.' . $this->foreignKey . '=' . $relation . '.' . $this->localKey, $this->joinType )->where ( $where );
	}
