       ...
       <tbody>
        <tr> 
         <td class="table-td-wrap" align="center" width="458"> 
          <table class="table-space" height="18" style="height: 18px; font-size: 0px; line-height: 0; width: 450px; background-color:
			 #e4e6e9;" width="450" bgcolor="#E4E6E9" cellspacing="0" cellpadding="0" border="0"> 
           <tbody> 
            <tr> 
                ...
                <tr>
                 <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left"> 
                  <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"> 
                   <tbody> 
                    <tr> 
                     <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: 400; 
						line-height: 19px; color: #DD5A43 ; margin: 0px; font-size: 32px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
					        <?php switch ($code) {?>
					            <?php case 1:?>
						            	恭喜:)
						            <?php break;?>
                  ...
                  <div style="font-family: Arial, sans-serif; color: #87B87F; letter-spacing:1px;font-size: 18px;height:50px;margin-top:20px"> 
                   <p ><b style="color: ##009966;display:block;"><?php echo(strip_tags($msg));?></b> </p>
                   <p> 页面自动 <a id="href" href="<?php echo($url);?>" style="color:#87B87F">跳转</a> 等待时间： <b id="wait"><?php echo($wait);?></b></p>
                ...
                <tr>
                 <td class="table-col-td" width="448" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left"> 
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                   <tbody>
                    <tr>
                     <td width="100%" align="center" bgcolor="#87B87F" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #87B87F;" valign="top">
						<a href="#" style="color: #ffffff; text-decoration: none; background-color: transparent;">大叔评估; 2017</a> <br /> </td>
                    </tr>
                   </tbody>
                  </table> </td>
                </tr>
